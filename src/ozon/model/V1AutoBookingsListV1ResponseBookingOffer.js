...
/**
 * The V1AutoBookingsListV1ResponseBookingOffer model module.
 * @module model/V1AutoBookingsListV1ResponseBookingOffer
 * @version 2.1
 */
class V1AutoBookingsListV1ResponseBookingOffer {
    /**
     * Constructs a new <code>V1AutoBookingsListV1ResponseBookingOffer</code>.
     * Информация о предложении.
     * @alias module:model/V1AutoBookingsListV1ResponseBookingOffer
     */
    constructor() { 
        
        V1AutoBookingsListV1ResponseBookingOffer.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V1AutoBookingsListV1ResponseBookingOffer</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V1AutoBookingsListV1ResponseBookingOffer} obj Optional instance to populate.
     * @return {module:model/V1AutoBookingsListV1ResponseBookingOffer} The populated <code>V1AutoBookingsListV1ResponseBookingOffer</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V1AutoBookingsListV1ResponseBookingOffer();
    ...
    /**
     * Validates the JSON data with respect to <code>V1AutoBookingsListV1ResponseBookingOffer</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V1AutoBookingsListV1ResponseBookingOffer</code>.
     */
 ...
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['item_id'] = undefined;

/**
 * Цена автомобиля без учёта скидок.
 * @member {String} price
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['price'] = undefined;

/**
 * Скидка при покупке в трейд-ин.
 * @member {String} trade_in_discount
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['trade_in_discount'] = undefined;

/**
 * Скидка при покупке в кредит.
 * @member {String} credit_discount
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['credit_discount'] = undefined;

/**
 * Максимальная скидка, возможная при выполнении условий всех действующих в этот момент акций.
 * @member {String} maximal_discount
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['maximal_discount'] = undefined;

/**
 * Полное наименование предложения.
 * @member {String} name
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['name'] = undefined;

/**
 * Тип предложения.
 * @member {module:model/V1AutoBookingsListV1ResponseBookingOffer.TypeEnum} type
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['type'] = undefined;

/**
 * Бренд автомобиля.
 * @member {String} brand
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['brand'] = undefined;

/**
 * Модель и поколение автомобиля.
 * @member {String} model
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['model'] = undefined;

/**
 * Модификация автомобиля.
 * @member {String} modification
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['modification'] = undefined;

/**
 * VIN автомобиля.
 * @member {String} vin
 */
V1AutoBookingsListV1ResponseBookingOffer.prototype['vin'] = undefined;
 ...
 * @readonly
 */
V1AutoBookingsListV1ResponseBookingOffer['TypeEnum'] = {
...
export default V1AutoBookingsListV1ResponseBookingOffer;
