...
/**
 * The GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo model module.
 * @module model/GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo
 * @version 2.1
 */
class GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo {
    /**
     * Constructs a new <code>GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo</code>.
     * Информация о возврате.
     * @alias module:model/GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo
     */
    constructor() { 
        
        GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.initialize(this);
    }
    ...
    /**
     * Constructs a <code>GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo} obj Optional instance to populate.
     * @return {module:model/GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo} The populated <code>GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo();
    ...
    /**
     * Validates the JSON data with respect to <code>GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo</code>.
     */
 ...
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['accepted_from_customer_moment'] = undefined;

/**
 * Идентификатор продавца.
 * @member {Number} company_id
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['company_id'] = undefined;

/**
 * Текущее местонахождение возврата.
 * @member {String} current_place_name
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['current_place_name'] = undefined;

/**
 * Место назначения возврата.
 * @member {String} dst_place_name
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['dst_place_name'] = undefined;

/**
 * Идентификатор возврата.
 * @member {Number} id
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['id'] = undefined;

/**
 * Признак вскрытия упаковки. `true`, если упаковка вскрыта.
 * @member {Boolean} is_opened
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['is_opened'] = undefined;

/**
 * Номер отправления.
 * @member {String} posting_number
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['posting_number'] = undefined;

/**
 * Причина возврата.
 * @member {String} return_reason_name
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['return_reason_name'] = undefined;

/**
 * Время доставки возврата на склад Ozon.
 * @member {Date} returned_to_ozon_moment
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['returned_to_ozon_moment'] = undefined;

/**
 * Идентификатор товара на Ozon.
 * @member {Number} sku
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['sku'] = undefined;

/**
 * Статус возврата.
 * @member {String} status_name
 */
GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo.prototype['status_name'] = undefined;
...
export default GetReturnsCompanyFboResponseGetReturnsCompanyItemFbo;
