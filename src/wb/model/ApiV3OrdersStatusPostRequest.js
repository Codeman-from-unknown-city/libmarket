...
/**
 * The ApiV3OrdersStatusPostRequest model module.
 * @module model/ApiV3OrdersStatusPostRequest
 * @version 1.6
 */
class ApiV3OrdersStatusPostRequest {
    /**
     * Constructs a new <code>ApiV3OrdersStatusPostRequest</code>.
     * @alias module:model/ApiV3OrdersStatusPostRequest
     */
    constructor() { 
        
        ApiV3OrdersStatusPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3OrdersStatusPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3OrdersStatusPostRequest} obj Optional instance to populate.
     * @return {module:model/ApiV3OrdersStatusPostRequest} The populated <code>ApiV3OrdersStatusPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3OrdersStatusPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3OrdersStatusPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3OrdersStatusPostRequest</code>.
     */
 ...
 */
ApiV3OrdersStatusPostRequest.prototype['orders'] = undefined;
...
export default ApiV3OrdersStatusPostRequest;
