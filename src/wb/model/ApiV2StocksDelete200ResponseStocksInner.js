...
/**
 * The ApiV2StocksDelete200ResponseStocksInner model module.
 * @module model/ApiV2StocksDelete200ResponseStocksInner
 * @version 1.6
 */
class ApiV2StocksDelete200ResponseStocksInner {
    /**
     * Constructs a new <code>ApiV2StocksDelete200ResponseStocksInner</code>.
     * @alias module:model/ApiV2StocksDelete200ResponseStocksInner
     */
    constructor() { 
        
        ApiV2StocksDelete200ResponseStocksInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2StocksDelete200ResponseStocksInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2StocksDelete200ResponseStocksInner} obj Optional instance to populate.
     * @return {module:model/ApiV2StocksDelete200ResponseStocksInner} The populated <code>ApiV2StocksDelete200ResponseStocksInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2StocksDelete200ResponseStocksInner();
            ...
            if (data.hasOwnProperty('isCargoDelivery')) {
                obj['isCargoDelivery'] = ApiClient.convertToType(data['isCargoDelivery'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2StocksDelete200ResponseStocksInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2StocksDelete200ResponseStocksInner</code>.
     */
 ...
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['subject'] = undefined;

/**
 * Бренд.
 * @member {String} brand
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['brand'] = undefined;

/**
 * Наименование.
 * @member {String} name
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['name'] = undefined;

/**
 * Размер.
 * @member {String} size
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['size'] = undefined;

/**
 * Баркод.
 * @member {String} barcode
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['barcode'] = undefined;

/**
 * Массив баркодов.
 * @member {Array.<String>} barcodes
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['barcodes'] = undefined;

/**
 * Артикул поставщика.
 * @member {String} article
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['article'] = undefined;

/**
 * Остаток.
 * @member {Number} stock
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['stock'] = undefined;

/**
 * Склад с товаром.
 * @member {String} warehouseName
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['warehouseName'] = undefined;

/**
 * ID склада.
 * @member {Number} warehouseId
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['warehouseId'] = undefined;

/**
 * @member {Number} id
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['id'] = undefined;

/**
 * @member {Number} chrtId
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['chrtId'] = undefined;

/**
 * @member {Number} nmId
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['nmId'] = undefined;

/**
 * @member {Boolean} isCargoDelivery
 */
ApiV2StocksDelete200ResponseStocksInner.prototype['isCargoDelivery'] = undefined;
...
export default ApiV2StocksDelete200ResponseStocksInner;
