...
/**
 * The ContentV1DirectoryColorsGet200ResponseDataInner model module.
 * @module model/ContentV1DirectoryColorsGet200ResponseDataInner
 * @version 1.6
 */
class ContentV1DirectoryColorsGet200ResponseDataInner {
    /**
     * Constructs a new <code>ContentV1DirectoryColorsGet200ResponseDataInner</code>.
     * @alias module:model/ContentV1DirectoryColorsGet200ResponseDataInner
     */
    constructor() { 
        
        ContentV1DirectoryColorsGet200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1DirectoryColorsGet200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1DirectoryColorsGet200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ContentV1DirectoryColorsGet200ResponseDataInner} The populated <code>ContentV1DirectoryColorsGet200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1DirectoryColorsGet200ResponseDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1DirectoryColorsGet200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1DirectoryColorsGet200ResponseDataInner</code>.
     */
 ...
 * @member {String} name
 */
ContentV1DirectoryColorsGet200ResponseDataInner.prototype['name'] = undefined;

/**
 * Наименование родительского цвета
 * @member {String} parentName
 */
ContentV1DirectoryColorsGet200ResponseDataInner.prototype['parentName'] = undefined;
...
export default ContentV1DirectoryColorsGet200ResponseDataInner;
