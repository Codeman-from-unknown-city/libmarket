...
/**
 * The ContentV1CardsUploadAddPostRequestCardsInnerSizesInner model module.
 * @module model/ContentV1CardsUploadAddPostRequestCardsInnerSizesInner
 * @version 1.6
 */
class ContentV1CardsUploadAddPostRequestCardsInnerSizesInner {
    /**
     * Constructs a new <code>ContentV1CardsUploadAddPostRequestCardsInnerSizesInner</code>.
     * @alias module:model/ContentV1CardsUploadAddPostRequestCardsInnerSizesInner
     */
    constructor() { 
        
        ContentV1CardsUploadAddPostRequestCardsInnerSizesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsUploadAddPostRequestCardsInnerSizesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsUploadAddPostRequestCardsInnerSizesInner} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsUploadAddPostRequestCardsInnerSizesInner} The populated <code>ContentV1CardsUploadAddPostRequestCardsInnerSizesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsUploadAddPostRequestCardsInnerSizesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsUploadAddPostRequestCardsInnerSizesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsUploadAddPostRequestCardsInnerSizesInner</code>.
     */
 ...
 */
ContentV1CardsUploadAddPostRequestCardsInnerSizesInner.prototype['techSize'] = undefined;

/**
 * Рос. размер
 * @member {String} wbSize
 */
ContentV1CardsUploadAddPostRequestCardsInnerSizesInner.prototype['wbSize'] = undefined;

/**
 * Цена
 * @member {Number} price
 */
ContentV1CardsUploadAddPostRequestCardsInnerSizesInner.prototype['price'] = undefined;
 ...
 */
ContentV1CardsUploadAddPostRequestCardsInnerSizesInner.prototype['skus'] = undefined;
...
export default ContentV1CardsUploadAddPostRequestCardsInnerSizesInner;
