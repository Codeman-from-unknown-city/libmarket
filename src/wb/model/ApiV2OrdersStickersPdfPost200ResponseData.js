...
/**
 * The ApiV2OrdersStickersPdfPost200ResponseData model module.
 * @module model/ApiV2OrdersStickersPdfPost200ResponseData
 * @version 1.6
 */
class ApiV2OrdersStickersPdfPost200ResponseData {
    /**
     * Constructs a new <code>ApiV2OrdersStickersPdfPost200ResponseData</code>.
     * @alias module:model/ApiV2OrdersStickersPdfPost200ResponseData
     */
    constructor() { 
        
        ApiV2OrdersStickersPdfPost200ResponseData.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2OrdersStickersPdfPost200ResponseData</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2OrdersStickersPdfPost200ResponseData} obj Optional instance to populate.
     * @return {module:model/ApiV2OrdersStickersPdfPost200ResponseData} The populated <code>ApiV2OrdersStickersPdfPost200ResponseData</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2OrdersStickersPdfPost200ResponseData();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2OrdersStickersPdfPost200ResponseData</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2OrdersStickersPdfPost200ResponseData</code>.
     */
 ...
 * @member {String} file
 */
ApiV2OrdersStickersPdfPost200ResponseData.prototype['file'] = undefined;

/**
 * Имя файла.
 * @member {String} name
 */
ApiV2OrdersStickersPdfPost200ResponseData.prototype['name'] = undefined;

/**
 * MIME type файла.
 * @member {String} mimeType
 */
ApiV2OrdersStickersPdfPost200ResponseData.prototype['mimeType'] = undefined;
...
export default ApiV2OrdersStickersPdfPost200ResponseData;
