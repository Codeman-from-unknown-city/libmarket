...
/**
 * The ContentV1CardsCursorListPost200ResponseDataCursor model module.
 * @module model/ContentV1CardsCursorListPost200ResponseDataCursor
 * @version 1.6
 */
class ContentV1CardsCursorListPost200ResponseDataCursor {
    /**
     * Constructs a new <code>ContentV1CardsCursorListPost200ResponseDataCursor</code>.
     * @alias module:model/ContentV1CardsCursorListPost200ResponseDataCursor
     */
    constructor() { 
        
        ContentV1CardsCursorListPost200ResponseDataCursor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsCursorListPost200ResponseDataCursor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsCursorListPost200ResponseDataCursor} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsCursorListPost200ResponseDataCursor} The populated <code>ContentV1CardsCursorListPost200ResponseDataCursor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsCursorListPost200ResponseDataCursor();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsCursorListPost200ResponseDataCursor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsCursorListPost200ResponseDataCursor</code>.
     */
 ...
 */
ContentV1CardsCursorListPost200ResponseDataCursor.prototype['updatedAt'] = undefined;

/**
 * Номер номенклатуры с которой надо запрашивтаь следующий список КТ
 * @member {Number} nmID
 */
ContentV1CardsCursorListPost200ResponseDataCursor.prototype['nmID'] = undefined;

/**
 * Кол-во возвращенных КТ
 * @member {Number} total
 */
ContentV1CardsCursorListPost200ResponseDataCursor.prototype['total'] = undefined;
...
export default ContentV1CardsCursorListPost200ResponseDataCursor;
