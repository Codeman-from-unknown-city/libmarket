...
/**
 * The ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts model module.
 * @module model/ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts
 * @version 1.6
 */
class ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts {
    /**
     * Constructs a new <code>ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts</code>.
     * @alias module:model/ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts
     */
    constructor() { 
        
        ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts} obj Optional instance to populate.
     * @return {module:model/ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts} The populated <code>ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts</code>.
     */
 ...
 * @member {String} A
 */
ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts.prototype['A'] = undefined;

/**
 * Вторая часть идентификатора этикетки.
 * @member {String} B
 */
ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts.prototype['B'] = undefined;
...
export default ApiV2OrdersStickersPost200ResponseDataInnerStickerWbStickerIdParts;
