...
import ContentV1CardsUploadAddPostRequestCardsInner from './ContentV1CardsUploadAddPostRequestCardsInner';

/**
 * The ContentV1CardsUploadAddPostRequest model module.
 * @module model/ContentV1CardsUploadAddPostRequest
 * @version 1.6
 */
class ContentV1CardsUploadAddPostRequest {
    /**
     * Constructs a new <code>ContentV1CardsUploadAddPostRequest</code>.
     * @alias module:model/ContentV1CardsUploadAddPostRequest
     */
    constructor() { 
        
        ContentV1CardsUploadAddPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsUploadAddPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsUploadAddPostRequest} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsUploadAddPostRequest} The populated <code>ContentV1CardsUploadAddPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsUploadAddPostRequest();

            if (data.hasOwnProperty('vendorCode')) {
                obj['vendorCode'] = ApiClient.convertToType(data['vendorCode'], 'String');
            }
            if (data.hasOwnProperty('cards')) {
                obj['cards'] = ApiClient.convertToType(data['cards'], [ContentV1CardsUploadAddPostRequestCardsInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsUploadAddPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsUploadAddPostRequest</code>.
     */
    static validateJSON(data) {
        ...
        if (data['cards']) { // data not null
            ...
            for (const item of data['cards']) {
                ContentV1CardsUploadAddPostRequestCardsInner.validateJsonObject(item);
            };
        }
...
/**
 * Артикул существующей НМ в КТ
 * @member {String} vendorCode
 */
ContentV1CardsUploadAddPostRequest.prototype['vendorCode'] = undefined;

/**
 * Массив НМ которые хотим добавить к КТ
 * @member {Array.<module:model/ContentV1CardsUploadAddPostRequestCardsInner>} cards
 */
ContentV1CardsUploadAddPostRequest.prototype['cards'] = undefined;
...
export default ContentV1CardsUploadAddPostRequest;
