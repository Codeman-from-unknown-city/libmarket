...
/**
 * The ApiV3SuppliesGetRequest model module.
 * @module model/ApiV3SuppliesGetRequest
 * @version 1.6
 */
class ApiV3SuppliesGetRequest {
    /**
     * Constructs a new <code>ApiV3SuppliesGetRequest</code>.
     * @alias module:model/ApiV3SuppliesGetRequest
     */
    constructor() { 
        
        ApiV3SuppliesGetRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3SuppliesGetRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3SuppliesGetRequest} obj Optional instance to populate.
     * @return {module:model/ApiV3SuppliesGetRequest} The populated <code>ApiV3SuppliesGetRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3SuppliesGetRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3SuppliesGetRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3SuppliesGetRequest</code>.
     */
 ...
 * @member {String} name
 */
ApiV3SuppliesGetRequest.prototype['name'] = undefined;
...
export default ApiV3SuppliesGetRequest;
