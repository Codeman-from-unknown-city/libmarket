...
import ContentV1CardsCursorListPostRequestSort from './ContentV1CardsCursorListPostRequestSort';

/**
 * The ContentV1CardsCursorListPostRequest model module.
 * @module model/ContentV1CardsCursorListPostRequest
 * @version 1.6
 */
class ContentV1CardsCursorListPostRequest {
    /**
     * Constructs a new <code>ContentV1CardsCursorListPostRequest</code>.
     * @alias module:model/ContentV1CardsCursorListPostRequest
     */
    constructor() { 
        
        ContentV1CardsCursorListPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsCursorListPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsCursorListPostRequest} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsCursorListPostRequest} The populated <code>ContentV1CardsCursorListPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsCursorListPostRequest();

            if (data.hasOwnProperty('sort')) {
                obj['sort'] = ContentV1CardsCursorListPostRequestSort.constructFromObject(data['sort']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsCursorListPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsCursorListPostRequest</code>.
     */
    static validateJSON(data) {
        // validate the optional field `sort`
        if (data['sort']) { // data not null
          ContentV1CardsCursorListPostRequestSort.validateJSON(data['sort']);
        }
...
/**
 * @member {module:model/ContentV1CardsCursorListPostRequestSort} sort
 */
ContentV1CardsCursorListPostRequest.prototype['sort'] = undefined;
...
export default ContentV1CardsCursorListPostRequest;
