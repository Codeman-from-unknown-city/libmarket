...
/**
 * The ApiV2StocksDelete200Response1DataErrorInner model module.
 * @module model/ApiV2StocksDelete200Response1DataErrorInner
 * @version 1.6
 */
class ApiV2StocksDelete200Response1DataErrorInner {
    /**
     * Constructs a new <code>ApiV2StocksDelete200Response1DataErrorInner</code>.
     * @alias module:model/ApiV2StocksDelete200Response1DataErrorInner
     */
    constructor() { 
        
        ApiV2StocksDelete200Response1DataErrorInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2StocksDelete200Response1DataErrorInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2StocksDelete200Response1DataErrorInner} obj Optional instance to populate.
     * @return {module:model/ApiV2StocksDelete200Response1DataErrorInner} The populated <code>ApiV2StocksDelete200Response1DataErrorInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2StocksDelete200Response1DataErrorInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2StocksDelete200Response1DataErrorInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2StocksDelete200Response1DataErrorInner</code>.
     */
 ...
 */
ApiV2StocksDelete200Response1DataErrorInner.prototype['barcode'] = undefined;

/**
 * Ошибка, случившаяся при загрудке остатка с данным баркодом.
 * @member {String} err
 */
ApiV2StocksDelete200Response1DataErrorInner.prototype['err'] = undefined;
...
export default ApiV2StocksDelete200Response1DataErrorInner;
