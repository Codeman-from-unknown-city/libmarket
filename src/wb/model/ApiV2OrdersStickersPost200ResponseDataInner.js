...
import ApiV2OrdersStickersPost200ResponseDataInnerSticker from './ApiV2OrdersStickersPost200ResponseDataInnerSticker';

/**
 * The ApiV2OrdersStickersPost200ResponseDataInner model module.
 * @module model/ApiV2OrdersStickersPost200ResponseDataInner
 * @version 1.6
 */
class ApiV2OrdersStickersPost200ResponseDataInner {
    /**
     * Constructs a new <code>ApiV2OrdersStickersPost200ResponseDataInner</code>.
     * @alias module:model/ApiV2OrdersStickersPost200ResponseDataInner
     */
    constructor() { 
        
        ApiV2OrdersStickersPost200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2OrdersStickersPost200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2OrdersStickersPost200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ApiV2OrdersStickersPost200ResponseDataInner} The populated <code>ApiV2OrdersStickersPost200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2OrdersStickersPost200ResponseDataInner();

            if (data.hasOwnProperty('orderId')) {
                obj['orderId'] = ApiClient.convertToType(data['orderId'], 'Number');
            }
            if (data.hasOwnProperty('sticker')) {
                obj['sticker'] = ApiV2OrdersStickersPost200ResponseDataInnerSticker.constructFromObject(data['sticker']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2OrdersStickersPost200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2OrdersStickersPost200ResponseDataInner</code>.
     */
    static validateJSON(data) {
        // validate the optional field `sticker`
        if (data['sticker']) { // data not null
          ApiV2OrdersStickersPost200ResponseDataInnerSticker.validateJSON(data['sticker']);
        }
 ...
 */
ApiV2OrdersStickersPost200ResponseDataInner.prototype['orderId'] = undefined;

/**
 * @member {module:model/ApiV2OrdersStickersPost200ResponseDataInnerSticker} sticker
 */
ApiV2OrdersStickersPost200ResponseDataInner.prototype['sticker'] = undefined;
...
export default ApiV2OrdersStickersPost200ResponseDataInner;
