...
import ApiV2OrdersStickersPdfPost200ResponseData from './ApiV2OrdersStickersPdfPost200ResponseData';

/**
 * The ApiV2OrdersStickersPdfPost200Response model module.
 * @module model/ApiV2OrdersStickersPdfPost200Response
 * @version 1.6
 */
class ApiV2OrdersStickersPdfPost200Response {
    /**
     * Constructs a new <code>ApiV2OrdersStickersPdfPost200Response</code>.
     * @alias module:model/ApiV2OrdersStickersPdfPost200Response
     */
    constructor() { 
        
        ApiV2OrdersStickersPdfPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2OrdersStickersPdfPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2OrdersStickersPdfPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV2OrdersStickersPdfPost200Response} The populated <code>ApiV2OrdersStickersPdfPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2OrdersStickersPdfPost200Response();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV2OrdersStickersPdfPost200ResponseData.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2OrdersStickersPdfPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2OrdersStickersPdfPost200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          ApiV2OrdersStickersPdfPost200ResponseData.validateJSON(data['data']);
        }
 ...
 */
ApiV2OrdersStickersPdfPost200Response.prototype['error'] = undefined;

/**
 * @member {String} errorText
 */
ApiV2OrdersStickersPdfPost200Response.prototype['errorText'] = undefined;

/**
 * @member {module:model/ApiV2OrdersStickersPdfPost200ResponseData} data
 */
ApiV2OrdersStickersPdfPost200Response.prototype['data'] = undefined;
...
export default ApiV2OrdersStickersPdfPost200Response;
