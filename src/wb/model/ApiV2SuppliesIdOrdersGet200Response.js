...
import ApiV2SuppliesIdOrdersGet200ResponseOrdersInner from './ApiV2SuppliesIdOrdersGet200ResponseOrdersInner';

/**
 * The ApiV2SuppliesIdOrdersGet200Response model module.
 * @module model/ApiV2SuppliesIdOrdersGet200Response
 * @version 1.6
 */
class ApiV2SuppliesIdOrdersGet200Response {
    /**
     * Constructs a new <code>ApiV2SuppliesIdOrdersGet200Response</code>.
     * @alias module:model/ApiV2SuppliesIdOrdersGet200Response
     */
    constructor() { 
        
        ApiV2SuppliesIdOrdersGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2SuppliesIdOrdersGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2SuppliesIdOrdersGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV2SuppliesIdOrdersGet200Response} The populated <code>ApiV2SuppliesIdOrdersGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2SuppliesIdOrdersGet200Response();

            if (data.hasOwnProperty('orders')) {
                obj['orders'] = ApiClient.convertToType(data['orders'], [ApiV2SuppliesIdOrdersGet200ResponseOrdersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2SuppliesIdOrdersGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2SuppliesIdOrdersGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['orders']) { // data not null
            ...
            for (const item of data['orders']) {
                ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV2SuppliesIdOrdersGet200ResponseOrdersInner>} orders
 */
ApiV2SuppliesIdOrdersGet200Response.prototype['orders'] = undefined;
...
export default ApiV2SuppliesIdOrdersGet200Response;
