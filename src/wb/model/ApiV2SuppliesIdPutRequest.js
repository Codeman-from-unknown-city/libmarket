...
/**
 * The ApiV2SuppliesIdPutRequest model module.
 * @module model/ApiV2SuppliesIdPutRequest
 * @version 1.6
 */
class ApiV2SuppliesIdPutRequest {
    /**
     * Constructs a new <code>ApiV2SuppliesIdPutRequest</code>.
     * @alias module:model/ApiV2SuppliesIdPutRequest
     */
    constructor() { 
        
        ApiV2SuppliesIdPutRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2SuppliesIdPutRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2SuppliesIdPutRequest} obj Optional instance to populate.
     * @return {module:model/ApiV2SuppliesIdPutRequest} The populated <code>ApiV2SuppliesIdPutRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2SuppliesIdPutRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2SuppliesIdPutRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2SuppliesIdPutRequest</code>.
     */
 ...
 */
ApiV2SuppliesIdPutRequest.prototype['orders'] = undefined;
...
export default ApiV2SuppliesIdPutRequest;
