...
/**
 * The ContentV1CardsFilterPostRequest model module.
 * @module model/ContentV1CardsFilterPostRequest
 * @version 1.6
 */
class ContentV1CardsFilterPostRequest {
    /**
     * Constructs a new <code>ContentV1CardsFilterPostRequest</code>.
     * @alias module:model/ContentV1CardsFilterPostRequest
     */
    constructor() { 
        
        ContentV1CardsFilterPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsFilterPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsFilterPostRequest} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsFilterPostRequest} The populated <code>ContentV1CardsFilterPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsFilterPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsFilterPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsFilterPostRequest</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['vendorCodes'])) {
            throw new Error("Expected the field `vendorCodes` to be an array in the JSON data but got " + data['vendorCodes']);
        }
...
/**
 * Массив идентификаторов НМ поставщика. <br>Максимальное количество в запросе `100`. 
 * @member {Array.<String>} vendorCodes
 */
ContentV1CardsFilterPostRequest.prototype['vendorCodes'] = undefined;
...
export default ContentV1CardsFilterPostRequest;
