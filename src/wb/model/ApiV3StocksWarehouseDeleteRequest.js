...
import ApiV3StocksWarehouseDeleteRequestStocksInner from './ApiV3StocksWarehouseDeleteRequestStocksInner';

/**
 * The ApiV3StocksWarehouseDeleteRequest model module.
 * @module model/ApiV3StocksWarehouseDeleteRequest
 * @version 1.6
 */
class ApiV3StocksWarehouseDeleteRequest {
    /**
     * Constructs a new <code>ApiV3StocksWarehouseDeleteRequest</code>.
     * @alias module:model/ApiV3StocksWarehouseDeleteRequest
     * @param stocks {Array.<module:model/ApiV3StocksWarehouseDeleteRequestStocksInner>} Массив баркодов товаров и их остатков
     */
    constructor(stocks) { 
        
        ApiV3StocksWarehouseDeleteRequest.initialize(this, stocks);
    }
    ...
    /**
     * Constructs a <code>ApiV3StocksWarehouseDeleteRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3StocksWarehouseDeleteRequest} obj Optional instance to populate.
     * @return {module:model/ApiV3StocksWarehouseDeleteRequest} The populated <code>ApiV3StocksWarehouseDeleteRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3StocksWarehouseDeleteRequest();

            if (data.hasOwnProperty('stocks')) {
                obj['stocks'] = ApiClient.convertToType(data['stocks'], [ApiV3StocksWarehouseDeleteRequestStocksInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3StocksWarehouseDeleteRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3StocksWarehouseDeleteRequest</code>.
     */
    static validateJSON(data) {
        // check to make sure all required properties are present in the JSON string
        for (const property of ApiV3StocksWarehouseDeleteRequest.RequiredProperties) {
            if (!data[property]) {
        ...
        if (data['stocks']) { // data not null
            ...
            for (const item of data['stocks']) {
                ApiV3StocksWarehouseDeleteRequestStocksInner.validateJsonObject(item);
            };
        }
...
ApiV3StocksWarehouseDeleteRequest.RequiredProperties = ["stocks"];

/**
 * Массив баркодов товаров и их остатков
 * @member {Array.<module:model/ApiV3StocksWarehouseDeleteRequestStocksInner>} stocks
 */
ApiV3StocksWarehouseDeleteRequest.prototype['stocks'] = undefined;
...
export default ApiV3StocksWarehouseDeleteRequest;
