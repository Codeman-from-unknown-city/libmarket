...
/**
 * The ContentV1ObjectParentAllGet200ResponseDataInner model module.
 * @module model/ContentV1ObjectParentAllGet200ResponseDataInner
 * @version 1.6
 */
class ContentV1ObjectParentAllGet200ResponseDataInner {
    /**
     * Constructs a new <code>ContentV1ObjectParentAllGet200ResponseDataInner</code>.
     * @alias module:model/ContentV1ObjectParentAllGet200ResponseDataInner
     */
    constructor() { 
        
        ContentV1ObjectParentAllGet200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1ObjectParentAllGet200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1ObjectParentAllGet200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ContentV1ObjectParentAllGet200ResponseDataInner} The populated <code>ContentV1ObjectParentAllGet200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1ObjectParentAllGet200ResponseDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1ObjectParentAllGet200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1ObjectParentAllGet200ResponseDataInner</code>.
     */
 ...
 * @member {String} name
 */
ContentV1ObjectParentAllGet200ResponseDataInner.prototype['name'] = undefined;

/**
 * Виден на сайте
 * @member {Boolean} isVisible
 */
ContentV1ObjectParentAllGet200ResponseDataInner.prototype['isVisible'] = undefined;
...
export default ContentV1ObjectParentAllGet200ResponseDataInner;
