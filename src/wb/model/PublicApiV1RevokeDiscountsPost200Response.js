...
/**
 * The PublicApiV1RevokeDiscountsPost200Response model module.
 * @module model/PublicApiV1RevokeDiscountsPost200Response
 * @version 1.6
 */
class PublicApiV1RevokeDiscountsPost200Response {
    /**
     * Constructs a new <code>PublicApiV1RevokeDiscountsPost200Response</code>.
     * @alias module:model/PublicApiV1RevokeDiscountsPost200Response
     */
    constructor() { 
        
        PublicApiV1RevokeDiscountsPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PublicApiV1RevokeDiscountsPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublicApiV1RevokeDiscountsPost200Response} obj Optional instance to populate.
     * @return {module:model/PublicApiV1RevokeDiscountsPost200Response} The populated <code>PublicApiV1RevokeDiscountsPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicApiV1RevokeDiscountsPost200Response();

            if (data.hasOwnProperty('uploadId')) {
                obj['uploadId'] = ApiClient.convertToType(data['uploadId'], 'Number');
            }
            if (data.hasOwnProperty('alreadyExists')) {
                obj['alreadyExists'] = ApiClient.convertToType(data['alreadyExists'], 'Boolean');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>PublicApiV1RevokeDiscountsPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicApiV1RevokeDiscountsPost200Response</code>.
     */
 ...
 */
PublicApiV1RevokeDiscountsPost200Response.prototype['uploadId'] = undefined;

/**
 * Данное поле обозначает что скидка уже была сброшена
 * @member {Boolean} alreadyExists
 */
PublicApiV1RevokeDiscountsPost200Response.prototype['alreadyExists'] = undefined;
...
export default PublicApiV1RevokeDiscountsPost200Response;
