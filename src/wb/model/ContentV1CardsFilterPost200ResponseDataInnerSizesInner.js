...
/**
 * The ContentV1CardsFilterPost200ResponseDataInnerSizesInner model module.
 * @module model/ContentV1CardsFilterPost200ResponseDataInnerSizesInner
 * @version 1.6
 */
class ContentV1CardsFilterPost200ResponseDataInnerSizesInner {
    /**
     * Constructs a new <code>ContentV1CardsFilterPost200ResponseDataInnerSizesInner</code>.
     * @alias module:model/ContentV1CardsFilterPost200ResponseDataInnerSizesInner
     */
    constructor() { 
        
        ContentV1CardsFilterPost200ResponseDataInnerSizesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsFilterPost200ResponseDataInnerSizesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsFilterPost200ResponseDataInnerSizesInner} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsFilterPost200ResponseDataInnerSizesInner} The populated <code>ContentV1CardsFilterPost200ResponseDataInnerSizesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsFilterPost200ResponseDataInnerSizesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsFilterPost200ResponseDataInnerSizesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsFilterPost200ResponseDataInnerSizesInner</code>.
     */
 ...
 */
ContentV1CardsFilterPost200ResponseDataInnerSizesInner.prototype['techSize'] = undefined;

/**
 * Рос. размер
 * @member {String} wbSize
 */
ContentV1CardsFilterPost200ResponseDataInnerSizesInner.prototype['wbSize'] = undefined;

/**
 * Цена
 * @member {Number} price
 */
ContentV1CardsFilterPost200ResponseDataInnerSizesInner.prototype['price'] = undefined;

/**
 * Числовой идентификатор размера для данной номенклатуры Wildberries
 * @member {Number} chrtID
 */
ContentV1CardsFilterPost200ResponseDataInnerSizesInner.prototype['chrtID'] = undefined;
 ...
 */
ContentV1CardsFilterPost200ResponseDataInnerSizesInner.prototype['skus'] = undefined;
...
export default ContentV1CardsFilterPost200ResponseDataInnerSizesInner;
