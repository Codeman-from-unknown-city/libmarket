...
import ContentV1CardsUploadPostRequestInnerInnerSizesInner from './ContentV1CardsUploadPostRequestInnerInnerSizesInner';

/**
 * The ContentV1CardsUploadPostRequestInnerInner model module.
 * @module model/ContentV1CardsUploadPostRequestInnerInner
 * @version 1.6
 */
class ContentV1CardsUploadPostRequestInnerInner {
    /**
     * Constructs a new <code>ContentV1CardsUploadPostRequestInnerInner</code>.
     * @alias module:model/ContentV1CardsUploadPostRequestInnerInner
     */
    constructor() { 
        
        ContentV1CardsUploadPostRequestInnerInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsUploadPostRequestInnerInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsUploadPostRequestInnerInner} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsUploadPostRequestInnerInner} The populated <code>ContentV1CardsUploadPostRequestInnerInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsUploadPostRequestInnerInner();
            ...
            if (data.hasOwnProperty('sizes')) {
                obj['sizes'] = ApiClient.convertToType(data['sizes'], [ContentV1CardsUploadPostRequestInnerInnerSizesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsUploadPostRequestInnerInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsUploadPostRequestInnerInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['sizes']) { // data not null
            ...
            for (const item of data['sizes']) {
                ContentV1CardsUploadPostRequestInnerInnerSizesInner.validateJsonObject(item);
            };
        }
 ...
 */
ContentV1CardsUploadPostRequestInnerInner.prototype['vendorCode'] = undefined;

/**
 * Массив характеристик, индивидуальный для каждой категории
 * @member {Array.<Object>} characteristics
 */
ContentV1CardsUploadPostRequestInnerInner.prototype['characteristics'] = undefined;
 ...
 * @member {Array.<module:model/ContentV1CardsUploadPostRequestInnerInnerSizesInner>} sizes
 */
ContentV1CardsUploadPostRequestInnerInner.prototype['sizes'] = undefined;
...
export default ContentV1CardsUploadPostRequestInnerInner;
