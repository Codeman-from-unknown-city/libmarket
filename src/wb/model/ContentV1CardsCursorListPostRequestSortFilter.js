...
/**
 * The ContentV1CardsCursorListPostRequestSortFilter model module.
 * @module model/ContentV1CardsCursorListPostRequestSortFilter
 * @version 1.6
 */
class ContentV1CardsCursorListPostRequestSortFilter {
    /**
     * Constructs a new <code>ContentV1CardsCursorListPostRequestSortFilter</code>.
     * @alias module:model/ContentV1CardsCursorListPostRequestSortFilter
     */
    constructor() { 
        
        ContentV1CardsCursorListPostRequestSortFilter.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsCursorListPostRequestSortFilter</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsCursorListPostRequestSortFilter} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsCursorListPostRequestSortFilter} The populated <code>ContentV1CardsCursorListPostRequestSortFilter</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsCursorListPostRequestSortFilter();

            if (data.hasOwnProperty('textSearch')) {
                obj['textSearch'] = ApiClient.convertToType(data['textSearch'], 'Number');
            }
            if (data.hasOwnProperty('withPhoto')) {
                obj['withPhoto'] = ApiClient.convertToType(data['withPhoto'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsCursorListPostRequestSortFilter</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsCursorListPostRequestSortFilter</code>.
     */
 ...
 * @member {Number} textSearch
 */
ContentV1CardsCursorListPostRequestSortFilter.prototype['textSearch'] = undefined;

/**
 * `-1` - Показать все КТ. <br>`0` - Показать КТ без фото. <br>`1` - Показать КТ с фото. 
 * @member {Number} withPhoto
 */
ContentV1CardsCursorListPostRequestSortFilter.prototype['withPhoto'] = undefined;
...
export default ContentV1CardsCursorListPostRequestSortFilter;
