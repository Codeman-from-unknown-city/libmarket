...
/**
 * The ResponseBodyError403 model module.
 * @module model/ResponseBodyError403
 * @version 1.6
 */
class ResponseBodyError403 {
    /**
     * Constructs a new <code>ResponseBodyError403</code>.
     * @alias module:model/ResponseBodyError403
     */
    constructor() { 
        
        ResponseBodyError403.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseBodyError403</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseBodyError403} obj Optional instance to populate.
     * @return {module:model/ResponseBodyError403} The populated <code>ResponseBodyError403</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseBodyError403();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseBodyError403</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseBodyError403</code>.
     */
 ...
 * @member {Object} data
 */
ResponseBodyError403.prototype['data'] = undefined;

/**
 * Флаг ошибки.
 * @member {Boolean} error
 */
ResponseBodyError403.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
ResponseBodyError403.prototype['errorText'] = undefined;

/**
 * Дополнительные ошибки.
 * @member {String} additionalErrors
 */
ResponseBodyError403.prototype['additionalErrors'] = undefined;
...
export default ResponseBodyError403;
