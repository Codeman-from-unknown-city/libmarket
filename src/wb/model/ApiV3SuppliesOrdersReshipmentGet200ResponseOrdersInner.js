...
/**
 * The ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner model module.
 * @module model/ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner
 * @version 1.6
 */
class ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner {
    /**
     * Constructs a new <code>ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner</code>.
     * @alias module:model/ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner
     */
    constructor() { 
        
        ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner} obj Optional instance to populate.
     * @return {module:model/ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner} The populated <code>ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner</code>.
     */
 ...
 */
ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner.prototype['supplyID'] = undefined;

/**
 * Идентификатор сборочного задания
 * @member {Number} orderID
 */
ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner.prototype['orderID'] = undefined;
...
export default ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner;
