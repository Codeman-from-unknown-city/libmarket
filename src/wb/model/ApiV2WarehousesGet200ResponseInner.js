...
/**
 * The ApiV2WarehousesGet200ResponseInner model module.
 * @module model/ApiV2WarehousesGet200ResponseInner
 * @version 1.6
 */
class ApiV2WarehousesGet200ResponseInner {
    /**
     * Constructs a new <code>ApiV2WarehousesGet200ResponseInner</code>.
     * @alias module:model/ApiV2WarehousesGet200ResponseInner
     */
    constructor() { 
        
        ApiV2WarehousesGet200ResponseInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2WarehousesGet200ResponseInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2WarehousesGet200ResponseInner} obj Optional instance to populate.
     * @return {module:model/ApiV2WarehousesGet200ResponseInner} The populated <code>ApiV2WarehousesGet200ResponseInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2WarehousesGet200ResponseInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2WarehousesGet200ResponseInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2WarehousesGet200ResponseInner</code>.
     */
 ...
 * @member {Number} id
 */
ApiV2WarehousesGet200ResponseInner.prototype['id'] = undefined;

/**
 * Наименование склада.
 * @member {String} name
 */
ApiV2WarehousesGet200ResponseInner.prototype['name'] = undefined;
...
export default ApiV2WarehousesGet200ResponseInner;
