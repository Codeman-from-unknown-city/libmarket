...
import ApiV2StocksDelete200ResponseStocksInner from './ApiV2StocksDelete200ResponseStocksInner';

/**
 * The ApiV2StocksDelete200Response model module.
 * @module model/ApiV2StocksDelete200Response
 * @version 1.6
 */
class ApiV2StocksDelete200Response {
    /**
     * Constructs a new <code>ApiV2StocksDelete200Response</code>.
     * @alias module:model/ApiV2StocksDelete200Response
     */
    constructor() { 
        
        ApiV2StocksDelete200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2StocksDelete200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2StocksDelete200Response} obj Optional instance to populate.
     * @return {module:model/ApiV2StocksDelete200Response} The populated <code>ApiV2StocksDelete200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2StocksDelete200Response();

            if (data.hasOwnProperty('total')) {
                obj['total'] = ApiClient.convertToType(data['total'], 'Number');
            }
            if (data.hasOwnProperty('stocks')) {
                obj['stocks'] = ApiClient.convertToType(data['stocks'], [ApiV2StocksDelete200ResponseStocksInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2StocksDelete200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2StocksDelete200Response</code>.
     */
    static validateJSON(data) {
        if (data['stocks']) { // data not null
            ...
            for (const item of data['stocks']) {
                ApiV2StocksDelete200ResponseStocksInner.validateJsonObject(item);
            };
        }
 ...
 * @member {Number} total
 */
ApiV2StocksDelete200Response.prototype['total'] = undefined;

/**
 * Описание остатка товара.
 * @member {Array.<module:model/ApiV2StocksDelete200ResponseStocksInner>} stocks
 */
ApiV2StocksDelete200Response.prototype['stocks'] = undefined;
...
export default ApiV2StocksDelete200Response;
