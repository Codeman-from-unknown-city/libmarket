...
/**
 * The ContentV1CardsUploadPostRequestInnerInnerSizesInner model module.
 * @module model/ContentV1CardsUploadPostRequestInnerInnerSizesInner
 * @version 1.6
 */
class ContentV1CardsUploadPostRequestInnerInnerSizesInner {
    /**
     * Constructs a new <code>ContentV1CardsUploadPostRequestInnerInnerSizesInner</code>.
     * @alias module:model/ContentV1CardsUploadPostRequestInnerInnerSizesInner
     */
    constructor() { 
        
        ContentV1CardsUploadPostRequestInnerInnerSizesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsUploadPostRequestInnerInnerSizesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsUploadPostRequestInnerInnerSizesInner} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsUploadPostRequestInnerInnerSizesInner} The populated <code>ContentV1CardsUploadPostRequestInnerInnerSizesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsUploadPostRequestInnerInnerSizesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsUploadPostRequestInnerInnerSizesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsUploadPostRequestInnerInnerSizesInner</code>.
     */
 ...
 */
ContentV1CardsUploadPostRequestInnerInnerSizesInner.prototype['techSize'] = undefined;

/**
 * Рос. размер
 * @member {String} wbSize
 */
ContentV1CardsUploadPostRequestInnerInnerSizesInner.prototype['wbSize'] = undefined;

/**
 * Цена (`указывается в рублях`)
 * @member {Number} price
 */
ContentV1CardsUploadPostRequestInnerInnerSizesInner.prototype['price'] = undefined;
 ...
 */
ContentV1CardsUploadPostRequestInnerInnerSizesInner.prototype['skus'] = undefined;
...
export default ContentV1CardsUploadPostRequestInnerInnerSizesInner;
