...
/**
 * The ContentV1ObjectAllGet200ResponseDataInner model module.
 * @module model/ContentV1ObjectAllGet200ResponseDataInner
 * @version 1.6
 */
class ContentV1ObjectAllGet200ResponseDataInner {
    /**
     * Constructs a new <code>ContentV1ObjectAllGet200ResponseDataInner</code>.
     * @alias module:model/ContentV1ObjectAllGet200ResponseDataInner
     */
    constructor() { 
        
        ContentV1ObjectAllGet200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1ObjectAllGet200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1ObjectAllGet200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ContentV1ObjectAllGet200ResponseDataInner} The populated <code>ContentV1ObjectAllGet200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1ObjectAllGet200ResponseDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1ObjectAllGet200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1ObjectAllGet200ResponseDataInner</code>.
     */
 ...
 */
ContentV1ObjectAllGet200ResponseDataInner.prototype['objectName'] = undefined;

/**
 * Название родительской категории
 * @member {String} parentName
 */
ContentV1ObjectAllGet200ResponseDataInner.prototype['parentName'] = undefined;

/**
 * Виден на сайте
 * @member {Boolean} isVisible
 */
ContentV1ObjectAllGet200ResponseDataInner.prototype['isVisible'] = undefined;
...
export default ContentV1ObjectAllGet200ResponseDataInner;
