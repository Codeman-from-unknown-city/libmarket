...
import ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner from './ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner';

/**
 * The ApiV3SuppliesOrdersReshipmentGet200Response model module.
 * @module model/ApiV3SuppliesOrdersReshipmentGet200Response
 * @version 1.6
 */
class ApiV3SuppliesOrdersReshipmentGet200Response {
    /**
     * Constructs a new <code>ApiV3SuppliesOrdersReshipmentGet200Response</code>.
     * @alias module:model/ApiV3SuppliesOrdersReshipmentGet200Response
     */
    constructor() { 
        
        ApiV3SuppliesOrdersReshipmentGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3SuppliesOrdersReshipmentGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3SuppliesOrdersReshipmentGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV3SuppliesOrdersReshipmentGet200Response} The populated <code>ApiV3SuppliesOrdersReshipmentGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3SuppliesOrdersReshipmentGet200Response();

            if (data.hasOwnProperty('orders')) {
                obj['orders'] = ApiClient.convertToType(data['orders'], [ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3SuppliesOrdersReshipmentGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3SuppliesOrdersReshipmentGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['orders']) { // data not null
            ...
            for (const item of data['orders']) {
                ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV3SuppliesOrdersReshipmentGet200ResponseOrdersInner>} orders
 */
ApiV3SuppliesOrdersReshipmentGet200Response.prototype['orders'] = undefined;
...
export default ApiV3SuppliesOrdersReshipmentGet200Response;
