...
/**
 * The ResponseBodyError400 model module.
 * @module model/ResponseBodyError400
 * @version 1.6
 */
class ResponseBodyError400 {
    /**
     * Constructs a new <code>ResponseBodyError400</code>.
     * @alias module:model/ResponseBodyError400
     */
    constructor() { 
        
        ResponseBodyError400.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseBodyError400</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseBodyError400} obj Optional instance to populate.
     * @return {module:model/ResponseBodyError400} The populated <code>ResponseBodyError400</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseBodyError400();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseBodyError400</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseBodyError400</code>.
     */
 ...
 * @member {Object} data
 */
ResponseBodyError400.prototype['data'] = undefined;

/**
 * Флаг ошибки.
 * @member {Boolean} error
 */
ResponseBodyError400.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
ResponseBodyError400.prototype['errorText'] = undefined;

/**
 * Дополнительные ошибки.
 * @member {String} additionalErrors
 */
ResponseBodyError400.prototype['additionalErrors'] = undefined;
...
export default ResponseBodyError400;
