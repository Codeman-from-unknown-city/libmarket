...
/**
 * The ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner model module.
 * @module model/ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner
 * @version 1.6
 */
class ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner {
    /**
     * Constructs a new <code>ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner</code>.
     * @alias module:model/ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner
     */
    constructor() { 
        
        ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner} obj Optional instance to populate.
     * @return {module:model/ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner} The populated <code>ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner();
            ...
            if (data.hasOwnProperty('numerator')) {
                obj['numerator'] = ApiClient.convertToType(data['numerator'], 'Number');
            }
            if (data.hasOwnProperty('denominator')) {
                obj['denominator'] = ApiClient.convertToType(data['denominator'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner</code>.
     */
 ...
 * @member {String} code
 */
ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner.prototype['code'] = undefined;

/**
 * Идентификатор места деятельности субъекта обращения в ИС МДЛП
 * @member {Number} sid
 */
ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner.prototype['sid'] = undefined;

/**
 * Числитель, количество единиц товара из упаковки (1, если продается целая упаковка)
 * @member {Number} numerator
 */
ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner.prototype['numerator'] = undefined;
 ...
 */
ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner.prototype['denominator'] = undefined;
...
export default ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner;
