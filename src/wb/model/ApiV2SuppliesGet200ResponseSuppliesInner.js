...
/**
 * The ApiV2SuppliesGet200ResponseSuppliesInner model module.
 * @module model/ApiV2SuppliesGet200ResponseSuppliesInner
 * @version 1.6
 */
class ApiV2SuppliesGet200ResponseSuppliesInner {
    /**
     * Constructs a new <code>ApiV2SuppliesGet200ResponseSuppliesInner</code>.
     * @alias module:model/ApiV2SuppliesGet200ResponseSuppliesInner
     */
    constructor() { 
        
        ApiV2SuppliesGet200ResponseSuppliesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2SuppliesGet200ResponseSuppliesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2SuppliesGet200ResponseSuppliesInner} obj Optional instance to populate.
     * @return {module:model/ApiV2SuppliesGet200ResponseSuppliesInner} The populated <code>ApiV2SuppliesGet200ResponseSuppliesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2SuppliesGet200ResponseSuppliesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2SuppliesGet200ResponseSuppliesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2SuppliesGet200ResponseSuppliesInner</code>.
     */
 ...
 */
ApiV2SuppliesGet200ResponseSuppliesInner.prototype['supplyId'] = undefined;
...
export default ApiV2SuppliesGet200ResponseSuppliesInner;
