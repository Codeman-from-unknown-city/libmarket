...
/**
 * The ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner model module.
 * @module model/ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner
 * @version 1.6
 */
class ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner {
    /**
     * Constructs a new <code>ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner</code>.
     * @alias module:model/ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner
     */
    constructor() { 
        
        ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner} The populated <code>ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner();
            ...
            if (data.hasOwnProperty('popular')) {
                obj['popular'] = ApiClient.convertToType(data['popular'], 'Boolean');
            }
            if (data.hasOwnProperty('charcType')) {
                obj['charcType'] = ApiClient.convertToType(data['charcType'], 'Number');
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner</code>.
     */
 ...
 */
ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner.prototype['objectName'] = undefined;

/**
 * Наименование характеристики
 * @member {String} name
 */
ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner.prototype['name'] = undefined;

/**
 * Характеристика обязательна к заполенению
 * @member {Boolean} required
 */
ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner.prototype['required'] = undefined;

/**
 * Единица имерения (см, гр и т.д.)
 * @member {String} unitName
 */
ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner.prototype['unitName'] = undefined;
 ...
 */
ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner.prototype['maxCount'] = undefined;

/**
 * Характеристика популярна у пользователей
 * @member {Boolean} popular
 */
ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner.prototype['popular'] = undefined;

/**
 * Тип характеристики (1 и 0 - строка или массив строк; 4 - число или массив чисел)
 * @member {Number} charcType
 */
ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner.prototype['charcType'] = undefined;
...
export default ContentV1ObjectCharacteristicsObjectNameGet200ResponseDataInner;
