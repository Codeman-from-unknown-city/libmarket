...
/**
 * The PublicApiV1PricesPostRequestInner model module.
 * @module model/PublicApiV1PricesPostRequestInner
 * @version 1.6
 */
class PublicApiV1PricesPostRequestInner {
    /**
     * Constructs a new <code>PublicApiV1PricesPostRequestInner</code>.
     * @alias module:model/PublicApiV1PricesPostRequestInner
     */
    constructor() { 
        
        PublicApiV1PricesPostRequestInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PublicApiV1PricesPostRequestInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublicApiV1PricesPostRequestInner} obj Optional instance to populate.
     * @return {module:model/PublicApiV1PricesPostRequestInner} The populated <code>PublicApiV1PricesPostRequestInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicApiV1PricesPostRequestInner();
    ...
    /**
     * Validates the JSON data with respect to <code>PublicApiV1PricesPostRequestInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicApiV1PricesPostRequestInner</code>.
     */
 ...
 * @member {Number} nmId
 */
PublicApiV1PricesPostRequestInner.prototype['nmId'] = undefined;

/**
 * Цена (указывать без копеек)
 * @member {Number} price
 */
PublicApiV1PricesPostRequestInner.prototype['price'] = undefined;
...
export default PublicApiV1PricesPostRequestInner;
