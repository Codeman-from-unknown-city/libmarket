...
/**
 * The ApiV3SuppliesSupplyOrdersGet200Response model module.
 * @module model/ApiV3SuppliesSupplyOrdersGet200Response
 * @version 1.6
 */
class ApiV3SuppliesSupplyOrdersGet200Response {
    /**
     * Constructs a new <code>ApiV3SuppliesSupplyOrdersGet200Response</code>.
     * @alias module:model/ApiV3SuppliesSupplyOrdersGet200Response
     */
    constructor() { 
        
        ApiV3SuppliesSupplyOrdersGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3SuppliesSupplyOrdersGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3SuppliesSupplyOrdersGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV3SuppliesSupplyOrdersGet200Response} The populated <code>ApiV3SuppliesSupplyOrdersGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3SuppliesSupplyOrdersGet200Response();

            if (data.hasOwnProperty('orders')) {
                obj['orders'] = ApiClient.convertToType(data['orders'], [SupplyOrder]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3SuppliesSupplyOrdersGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3SuppliesSupplyOrdersGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['orders']) { // data not null
            ...
            for (const item of data['orders']) {
                SupplyOrder.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/SupplyOrder>} orders
 */
ApiV3SuppliesSupplyOrdersGet200Response.prototype['orders'] = undefined;
...
export default ApiV3SuppliesSupplyOrdersGet200Response;
