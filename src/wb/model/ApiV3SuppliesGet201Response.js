...
/**
 * The ApiV3SuppliesGet201Response model module.
 * @module model/ApiV3SuppliesGet201Response
 * @version 1.6
 */
class ApiV3SuppliesGet201Response {
    /**
     * Constructs a new <code>ApiV3SuppliesGet201Response</code>.
     * @alias module:model/ApiV3SuppliesGet201Response
     */
    constructor() { 
        
        ApiV3SuppliesGet201Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3SuppliesGet201Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3SuppliesGet201Response} obj Optional instance to populate.
     * @return {module:model/ApiV3SuppliesGet201Response} The populated <code>ApiV3SuppliesGet201Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3SuppliesGet201Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3SuppliesGet201Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3SuppliesGet201Response</code>.
     */
 ...
 * @member {String} id
 */
ApiV3SuppliesGet201Response.prototype['id'] = undefined;
...
export default ApiV3SuppliesGet201Response;
