...
/**
 * The ApiV3StocksWarehouseDelete200ResponseStocksInner model module.
 * @module model/ApiV3StocksWarehouseDelete200ResponseStocksInner
 * @version 1.6
 */
class ApiV3StocksWarehouseDelete200ResponseStocksInner {
    /**
     * Constructs a new <code>ApiV3StocksWarehouseDelete200ResponseStocksInner</code>.
     * @alias module:model/ApiV3StocksWarehouseDelete200ResponseStocksInner
     */
    constructor() { 
        
        ApiV3StocksWarehouseDelete200ResponseStocksInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3StocksWarehouseDelete200ResponseStocksInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3StocksWarehouseDelete200ResponseStocksInner} obj Optional instance to populate.
     * @return {module:model/ApiV3StocksWarehouseDelete200ResponseStocksInner} The populated <code>ApiV3StocksWarehouseDelete200ResponseStocksInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3StocksWarehouseDelete200ResponseStocksInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3StocksWarehouseDelete200ResponseStocksInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3StocksWarehouseDelete200ResponseStocksInner</code>.
     */
 ...
 * @member {String} sku
 */
ApiV3StocksWarehouseDelete200ResponseStocksInner.prototype['sku'] = undefined;

/**
 * Остаток
 * @member {Number} amount
 */
ApiV3StocksWarehouseDelete200ResponseStocksInner.prototype['amount'] = undefined;
...
export default ApiV3StocksWarehouseDelete200ResponseStocksInner;
