...
/**
 * The ApiV2SuppliesIdOrdersGet200ResponseOrdersInner model module.
 * @module model/ApiV2SuppliesIdOrdersGet200ResponseOrdersInner
 * @version 1.6
 */
class ApiV2SuppliesIdOrdersGet200ResponseOrdersInner {
    /**
     * Constructs a new <code>ApiV2SuppliesIdOrdersGet200ResponseOrdersInner</code>.
     * @alias module:model/ApiV2SuppliesIdOrdersGet200ResponseOrdersInner
     */
    constructor() { 
        
        ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2SuppliesIdOrdersGet200ResponseOrdersInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2SuppliesIdOrdersGet200ResponseOrdersInner} obj Optional instance to populate.
     * @return {module:model/ApiV2SuppliesIdOrdersGet200ResponseOrdersInner} The populated <code>ApiV2SuppliesIdOrdersGet200ResponseOrdersInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2SuppliesIdOrdersGet200ResponseOrdersInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2SuppliesIdOrdersGet200ResponseOrdersInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2SuppliesIdOrdersGet200ResponseOrdersInner</code>.
     */
 ...
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['orderId'] = undefined;

/**
 * Дата создания заказа `(RFC3339)`.
 * @member {String} dateCreated
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['dateCreated'] = undefined;

/**
 * Идентификатор склада поставщика, на который пришел заказ.
 * @member {Number} storeId
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['storeId'] = undefined;

/**
 * Идентификатор склада WB, на которой заказ должен быть доставлен.
 * @member {Number} wbWhId
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['wbWhId'] = undefined;

/**
 * Идентификатор ПВЗ/магазина, куда необходимо доставить заказ (если применимо).
 * @member {Number} pid
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['pid'] = undefined;

/**
 * Адрес ПВЗ/магазина, куда необходимо доставить заказ (если применимо).
 * @member {String} officeAddress
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['officeAddress'] = undefined;

/**
 * Идентификатор артикула.
 * @member {Number} chrtId
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['chrtId'] = undefined;

/**
 * Массив штрихкодов товара.
 * @member {Array.<String>} barcodes
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['barcodes'] = undefined;
 ...
 * @member {module:model/ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.StatusEnum} status
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['status'] = undefined;

/**
 * Статус выставляемый Wildberries. <br>`0` - Новый заказ. <br>`1` - Отмена клиента. <br>`2` - Доставлен. <br>`3` - Возврат. <br>`4` - Ожидает. <br>`5` - Брак. 
 * @member {module:model/ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.UserStatusEnum} userStatus
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['userStatus'] = undefined;

/**
 * Уникальный идентификатор вещи, `разный у одинаковых chrt_id`.
 * @member {String} rid
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['rid'] = undefined;

/**
 * Цена в валюте продажи с учетом скидок в копейках. `Код валюты продажи в поле currencyCode`.
 * @member {Number} totalPrice
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['totalPrice'] = undefined;
 ...
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['currencyCode'] = undefined;

/**
 * Идентификатор транзакции (для группировки заказов).
 * @member {String} orderUID
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['orderUID'] = undefined;

/**
 * Тип доставки:   <ul>     <li>`1` - Обычная доставка.     <li>`2` - Доставка силами поставщика.   </ul> 
 * @member {module:model/ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.DeliveryTypeEnum} deliveryType
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner.prototype['deliveryType'] = undefined;
 ...
 * @readonly
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner['StatusEnum'] = {
 ...
 * @readonly
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner['UserStatusEnum'] = {
 ...
 * @readonly
 */
ApiV2SuppliesIdOrdersGet200ResponseOrdersInner['DeliveryTypeEnum'] = {
...
export default ApiV2SuppliesIdOrdersGet200ResponseOrdersInner;
