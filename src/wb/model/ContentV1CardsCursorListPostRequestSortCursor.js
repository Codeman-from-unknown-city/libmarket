...
/**
 * The ContentV1CardsCursorListPostRequestSortCursor model module.
 * @module model/ContentV1CardsCursorListPostRequestSortCursor
 * @version 1.6
 */
class ContentV1CardsCursorListPostRequestSortCursor {
    /**
     * Constructs a new <code>ContentV1CardsCursorListPostRequestSortCursor</code>.
     * @alias module:model/ContentV1CardsCursorListPostRequestSortCursor
     */
    constructor() { 
        
        ContentV1CardsCursorListPostRequestSortCursor.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsCursorListPostRequestSortCursor</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsCursorListPostRequestSortCursor} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsCursorListPostRequestSortCursor} The populated <code>ContentV1CardsCursorListPostRequestSortCursor</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsCursorListPostRequestSortCursor();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsCursorListPostRequestSortCursor</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsCursorListPostRequestSortCursor</code>.
     */
 ...
 */
ContentV1CardsCursorListPostRequestSortCursor.prototype['updatedAt'] = undefined;

/**
 * Номенклатура последней КТ из предыдущего ответа на запрос списка КТ.
 * @member {Number} nmID
 */
ContentV1CardsCursorListPostRequestSortCursor.prototype['nmID'] = undefined;

/**
 * Кол-во запрашиваемых КТ.
 * @member {Number} limit
 */
ContentV1CardsCursorListPostRequestSortCursor.prototype['limit'] = undefined;
...
export default ContentV1CardsCursorListPostRequestSortCursor;
