...
import ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner from './ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner';

/**
 * The ContentV1CardsCursorListPost200ResponseDataCardsInner model module.
 * @module model/ContentV1CardsCursorListPost200ResponseDataCardsInner
 * @version 1.6
 */
class ContentV1CardsCursorListPost200ResponseDataCardsInner {
    /**
     * Constructs a new <code>ContentV1CardsCursorListPost200ResponseDataCardsInner</code>.
     * @alias module:model/ContentV1CardsCursorListPost200ResponseDataCardsInner
     */
    constructor() { 
        
        ContentV1CardsCursorListPost200ResponseDataCardsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsCursorListPost200ResponseDataCardsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsCursorListPost200ResponseDataCardsInner} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsCursorListPost200ResponseDataCardsInner} The populated <code>ContentV1CardsCursorListPost200ResponseDataCardsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsCursorListPost200ResponseDataCardsInner();

            if (data.hasOwnProperty('sizes')) {
                obj['sizes'] = ApiClient.convertToType(data['sizes'], [ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsCursorListPost200ResponseDataCardsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsCursorListPost200ResponseDataCardsInner</code>.
     */
    static validateJSON(data) {
        if (data['sizes']) { // data not null
            ...
            for (const item of data['sizes']) {
                ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner.validateJsonObject(item);
            };
        }
        // ensure the json data is an array
 ...
 * @member {Array.<module:model/ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner>} sizes
 */
ContentV1CardsCursorListPost200ResponseDataCardsInner.prototype['sizes'] = undefined;

/**
 * Медиафайлы номенклатуры
 * @member {Array.<String>} mediaFiles
 */
ContentV1CardsCursorListPost200ResponseDataCardsInner.prototype['mediaFiles'] = undefined;

/**
 * Цвета номенклатуры
 * @member {Array.<String>} colors
 */
ContentV1CardsCursorListPost200ResponseDataCardsInner.prototype['colors'] = undefined;

/**
 * Дата обновления
 * @member {String} updateAt
 */
ContentV1CardsCursorListPost200ResponseDataCardsInner.prototype['updateAt'] = undefined;

/**
 * Текстовый идентификатор НМ поставщика
 * @member {String} vendorCode
 */
ContentV1CardsCursorListPost200ResponseDataCardsInner.prototype['vendorCode'] = undefined;

/**
 * Брэнд
 * @member {String} brand
 */
ContentV1CardsCursorListPost200ResponseDataCardsInner.prototype['brand'] = undefined;

/**
 * Категория для который создавалось КТ с данной НМ
 * @member {String} object
 */
ContentV1CardsCursorListPost200ResponseDataCardsInner.prototype['object'] = undefined;

/**
 * Числовой идентификатор номенклатуры Wildberries
 * @member {Number} nmID
 */
ContentV1CardsCursorListPost200ResponseDataCardsInner.prototype['nmID'] = undefined;
...
export default ContentV1CardsCursorListPost200ResponseDataCardsInner;
