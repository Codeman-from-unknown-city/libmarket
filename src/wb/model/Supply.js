...
class Supply {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('scanDt')) {
                obj['scanDt'] = ApiClient.convertToType(data['scanDt'], 'Date');
            }
 ...
 * @member {Boolean} done
 */
Supply.prototype['done'] = undefined;

/**
 * Дата создания поставки (RFC3339)
 * @member {Date} createdAt
 */
Supply.prototype['createdAt'] = undefined;

/**
 * Дата закрытия поставки (RFC3339)
 * @member {Date} closedAt
 */
Supply.prototype['closedAt'] = undefined;

/**
 * Дата скана поставки (RFC3339)
 * @member {Date} scanDt
 */
Supply.prototype['scanDt'] = undefined;
 ...
 */
Supply.prototype['isLargeCargo'] = undefined;
