...
/**
 * The ContentV1CardsErrorListGet200ResponseDataInner model module.
 * @module model/ContentV1CardsErrorListGet200ResponseDataInner
 * @version 1.6
 */
class ContentV1CardsErrorListGet200ResponseDataInner {
    /**
     * Constructs a new <code>ContentV1CardsErrorListGet200ResponseDataInner</code>.
     * @alias module:model/ContentV1CardsErrorListGet200ResponseDataInner
     */
    constructor() { 
        
        ContentV1CardsErrorListGet200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsErrorListGet200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsErrorListGet200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsErrorListGet200ResponseDataInner} The populated <code>ContentV1CardsErrorListGet200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsErrorListGet200ResponseDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsErrorListGet200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsErrorListGet200ResponseDataInner</code>.
     */
 ...
 */
ContentV1CardsErrorListGet200ResponseDataInner.prototype['object'] = undefined;

/**
 * Текстовый идентификатор НМ поставщика
 * @member {String} vendorCode
 */
ContentV1CardsErrorListGet200ResponseDataInner.prototype['vendorCode'] = undefined;

/**
 * Дата и время запроса на создание КТ с данным НМ
 * @member {String} updatedAt
 */
ContentV1CardsErrorListGet200ResponseDataInner.prototype['updatedAt'] = undefined;

/**
 * Список ошибок из-за которых не обработался запрос на создание КТ с данным НМ
 * @member {Array.<String>} errors
 */
ContentV1CardsErrorListGet200ResponseDataInner.prototype['errors'] = undefined;
...
export default ContentV1CardsErrorListGet200ResponseDataInner;
