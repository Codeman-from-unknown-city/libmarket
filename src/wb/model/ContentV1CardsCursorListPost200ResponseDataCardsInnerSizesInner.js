...
/**
 * The ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner model module.
 * @module model/ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner
 * @version 1.6
 */
class ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner {
    /**
     * Constructs a new <code>ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner</code>.
     * @alias module:model/ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner
     */
    constructor() { 
        
        ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner} The populated <code>ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner</code>.
     */
 ...
 */
ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner.prototype['techSize'] = undefined;
 ...
 */
ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner.prototype['skus'] = undefined;
...
export default ContentV1CardsCursorListPost200ResponseDataCardsInnerSizesInner;
