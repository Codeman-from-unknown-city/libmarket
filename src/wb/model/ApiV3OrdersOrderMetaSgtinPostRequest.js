...
import ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner from './ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner';

/**
 * The ApiV3OrdersOrderMetaSgtinPostRequest model module.
 * @module model/ApiV3OrdersOrderMetaSgtinPostRequest
 * @version 1.6
 */
class ApiV3OrdersOrderMetaSgtinPostRequest {
    /**
     * Constructs a new <code>ApiV3OrdersOrderMetaSgtinPostRequest</code>.
     * @alias module:model/ApiV3OrdersOrderMetaSgtinPostRequest
     */
    constructor() { 
        
        ApiV3OrdersOrderMetaSgtinPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3OrdersOrderMetaSgtinPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3OrdersOrderMetaSgtinPostRequest} obj Optional instance to populate.
     * @return {module:model/ApiV3OrdersOrderMetaSgtinPostRequest} The populated <code>ApiV3OrdersOrderMetaSgtinPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3OrdersOrderMetaSgtinPostRequest();

            if (data.hasOwnProperty('sgtin')) {
                obj['sgtin'] = ApiClient.convertToType(data['sgtin'], [ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3OrdersOrderMetaSgtinPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3OrdersOrderMetaSgtinPostRequest</code>.
     */
    static validateJSON(data) {
        if (data['sgtin']) { // data not null
            ...
            for (const item of data['sgtin']) {
                ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner.validateJsonObject(item);
            };
        }
...
/**
 * Массив КиЗов.
 * @member {Array.<module:model/ApiV3OrdersOrderMetaSgtinPostRequestSgtinInner>} sgtin
 */
ApiV3OrdersOrderMetaSgtinPostRequest.prototype['sgtin'] = undefined;
...
export default ApiV3OrdersOrderMetaSgtinPostRequest;
