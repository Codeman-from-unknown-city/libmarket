...
/**
 * The ApiV3StocksWarehouseDeleteRequest1 model module.
 * @module model/ApiV3StocksWarehouseDeleteRequest1
 * @version 1.6
 */
class ApiV3StocksWarehouseDeleteRequest1 {
    /**
     * Constructs a new <code>ApiV3StocksWarehouseDeleteRequest1</code>.
     * @alias module:model/ApiV3StocksWarehouseDeleteRequest1
     */
    constructor() { 
        
        ApiV3StocksWarehouseDeleteRequest1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3StocksWarehouseDeleteRequest1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3StocksWarehouseDeleteRequest1} obj Optional instance to populate.
     * @return {module:model/ApiV3StocksWarehouseDeleteRequest1} The populated <code>ApiV3StocksWarehouseDeleteRequest1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3StocksWarehouseDeleteRequest1();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3StocksWarehouseDeleteRequest1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3StocksWarehouseDeleteRequest1</code>.
     */
 ...
 */
ApiV3StocksWarehouseDeleteRequest1.prototype['skus'] = undefined;
...
export default ApiV3StocksWarehouseDeleteRequest1;
