...
/**
 * The ApiV2StocksDeleteRequestInner model module.
 * @module model/ApiV2StocksDeleteRequestInner
 * @version 1.6
 */
class ApiV2StocksDeleteRequestInner {
    /**
     * Constructs a new <code>ApiV2StocksDeleteRequestInner</code>.
     * @alias module:model/ApiV2StocksDeleteRequestInner
     */
    constructor() { 
        
        ApiV2StocksDeleteRequestInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2StocksDeleteRequestInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2StocksDeleteRequestInner} obj Optional instance to populate.
     * @return {module:model/ApiV2StocksDeleteRequestInner} The populated <code>ApiV2StocksDeleteRequestInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2StocksDeleteRequestInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2StocksDeleteRequestInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2StocksDeleteRequestInner</code>.
     */
 ...
 */
ApiV2StocksDeleteRequestInner.prototype['barcode'] = undefined;

/**
 * Остаток.
 * @member {Number} stock
 */
ApiV2StocksDeleteRequestInner.prototype['stock'] = undefined;

/**
 * ID склада.
 * @member {Number} warehouseId
 */
ApiV2StocksDeleteRequestInner.prototype['warehouseId'] = undefined;
...
export default ApiV2StocksDeleteRequestInner;
