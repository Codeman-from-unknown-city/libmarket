...
import ContentV1CardsCursorListPost200ResponseData from './ContentV1CardsCursorListPost200ResponseData';

/**
 * The ContentV1CardsCursorListPost200Response model module.
 * @module model/ContentV1CardsCursorListPost200Response
 * @version 1.6
 */
class ContentV1CardsCursorListPost200Response {
    /**
     * Constructs a new <code>ContentV1CardsCursorListPost200Response</code>.
     * @alias module:model/ContentV1CardsCursorListPost200Response
     */
    constructor() { 
        
        ContentV1CardsCursorListPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsCursorListPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsCursorListPost200Response} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsCursorListPost200Response} The populated <code>ContentV1CardsCursorListPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsCursorListPost200Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ContentV1CardsCursorListPost200ResponseData.constructFromObject(data['data']);
            }
            ...
            if (data.hasOwnProperty('additionalErrors')) {
                obj['additionalErrors'] = ApiClient.convertToType(data['additionalErrors'], Object);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsCursorListPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsCursorListPost200Response</code>.
     */
    static validateJSON(data) {
        // validate the optional field `data`
        if (data['data']) { // data not null
          ContentV1CardsCursorListPost200ResponseData.validateJSON(data['data']);
        }
...
/**
 * @member {module:model/ContentV1CardsCursorListPost200ResponseData} data
 */
ContentV1CardsCursorListPost200Response.prototype['data'] = undefined;

/**
 * Флаг ошибки
 * @member {Boolean} error
 */
ContentV1CardsCursorListPost200Response.prototype['error'] = undefined;

/**
 * Описание ошибки
 * @member {String} errorText
 */
ContentV1CardsCursorListPost200Response.prototype['errorText'] = undefined;

/**
 * Дополнительные ошибки
 * @member {Object} additionalErrors
 */
ContentV1CardsCursorListPost200Response.prototype['additionalErrors'] = undefined;
...
export default ContentV1CardsCursorListPost200Response;
