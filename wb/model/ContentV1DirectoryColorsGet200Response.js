...
import ContentV1DirectoryColorsGet200ResponseDataInner from './ContentV1DirectoryColorsGet200ResponseDataInner';

/**
 * The ContentV1DirectoryColorsGet200Response model module.
 * @module model/ContentV1DirectoryColorsGet200Response
 * @version 1.6
 */
class ContentV1DirectoryColorsGet200Response {
    /**
     * Constructs a new <code>ContentV1DirectoryColorsGet200Response</code>.
     * @alias module:model/ContentV1DirectoryColorsGet200Response
     */
    constructor() { 
        
        ContentV1DirectoryColorsGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1DirectoryColorsGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1DirectoryColorsGet200Response} obj Optional instance to populate.
     * @return {module:model/ContentV1DirectoryColorsGet200Response} The populated <code>ContentV1DirectoryColorsGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1DirectoryColorsGet200Response();

            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ContentV1DirectoryColorsGet200ResponseDataInner]);
            }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1DirectoryColorsGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1DirectoryColorsGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ContentV1DirectoryColorsGet200ResponseDataInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ContentV1DirectoryColorsGet200ResponseDataInner>} data
 */
ContentV1DirectoryColorsGet200Response.prototype['data'] = undefined;

/**
 * Флаг ошибки.
 * @member {Boolean} error
 */
ContentV1DirectoryColorsGet200Response.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
ContentV1DirectoryColorsGet200Response.prototype['errorText'] = undefined;

/**
 * Дополнительные ошибки.
 * @member {String} additionalErrors
 */
ContentV1DirectoryColorsGet200Response.prototype['additionalErrors'] = undefined;
...
export default ContentV1DirectoryColorsGet200Response;
