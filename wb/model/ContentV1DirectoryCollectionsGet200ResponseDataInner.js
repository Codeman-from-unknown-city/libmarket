...
/**
 * The ContentV1DirectoryCollectionsGet200ResponseDataInner model module.
 * @module model/ContentV1DirectoryCollectionsGet200ResponseDataInner
 * @version 1.6
 */
class ContentV1DirectoryCollectionsGet200ResponseDataInner {
    /**
     * Constructs a new <code>ContentV1DirectoryCollectionsGet200ResponseDataInner</code>.
     * @alias module:model/ContentV1DirectoryCollectionsGet200ResponseDataInner
     */
    constructor() { 
        
        ContentV1DirectoryCollectionsGet200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1DirectoryCollectionsGet200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1DirectoryCollectionsGet200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ContentV1DirectoryCollectionsGet200ResponseDataInner} The populated <code>ContentV1DirectoryCollectionsGet200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1DirectoryCollectionsGet200ResponseDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1DirectoryCollectionsGet200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1DirectoryCollectionsGet200ResponseDataInner</code>.
     */
 ...
 * @member {Number} id
 */
ContentV1DirectoryCollectionsGet200ResponseDataInner.prototype['id'] = undefined;

/**
 * Значение характеристики
 * @member {String} name
 */
ContentV1DirectoryCollectionsGet200ResponseDataInner.prototype['name'] = undefined;
...
export default ContentV1DirectoryCollectionsGet200ResponseDataInner;
