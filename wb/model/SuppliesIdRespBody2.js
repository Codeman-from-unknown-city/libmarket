...
import SuppliesIdRespBody2Data from './SuppliesIdRespBody2Data';

/**
 * The SuppliesIdRespBody2 model module.
 * @module model/SuppliesIdRespBody2
 * @version 1.6
 */
class SuppliesIdRespBody2 {
    /**
     * Constructs a new <code>SuppliesIdRespBody2</code>.
     * @alias module:model/SuppliesIdRespBody2
     */
    constructor() { 
        
        SuppliesIdRespBody2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SuppliesIdRespBody2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuppliesIdRespBody2} obj Optional instance to populate.
     * @return {module:model/SuppliesIdRespBody2} The populated <code>SuppliesIdRespBody2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuppliesIdRespBody2();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = SuppliesIdRespBody2Data.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SuppliesIdRespBody2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuppliesIdRespBody2</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          SuppliesIdRespBody2Data.validateJSON(data['data']);
        }
 ...
 */
SuppliesIdRespBody2.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
SuppliesIdRespBody2.prototype['errorText'] = undefined;

/**
 * Дополнительные ошибки.
 * @member {Object} additionalErrors
 */
SuppliesIdRespBody2.prototype['additionalErrors'] = undefined;

/**
 * @member {module:model/SuppliesIdRespBody2Data} data
 */
SuppliesIdRespBody2.prototype['data'] = undefined;
...
export default SuppliesIdRespBody2;
