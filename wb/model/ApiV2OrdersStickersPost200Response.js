...
import ApiV2OrdersStickersPost200ResponseDataInner from './ApiV2OrdersStickersPost200ResponseDataInner';

/**
 * The ApiV2OrdersStickersPost200Response model module.
 * @module model/ApiV2OrdersStickersPost200Response
 * @version 1.6
 */
class ApiV2OrdersStickersPost200Response {
    /**
     * Constructs a new <code>ApiV2OrdersStickersPost200Response</code>.
     * @alias module:model/ApiV2OrdersStickersPost200Response
     */
    constructor() { 
        
        ApiV2OrdersStickersPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2OrdersStickersPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2OrdersStickersPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV2OrdersStickersPost200Response} The populated <code>ApiV2OrdersStickersPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2OrdersStickersPost200Response();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ApiV2OrdersStickersPost200ResponseDataInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2OrdersStickersPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2OrdersStickersPost200Response</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ApiV2OrdersStickersPost200ResponseDataInner.validateJsonObject(item);
            };
        }
 ...
 */
ApiV2OrdersStickersPost200Response.prototype['additionalErrors'] = undefined;

/**
 * Флаг ошибки.
 * @member {Boolean} error
 */
ApiV2OrdersStickersPost200Response.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
ApiV2OrdersStickersPost200Response.prototype['errorText'] = undefined;

/**
 * @member {Array.<module:model/ApiV2OrdersStickersPost200ResponseDataInner>} data
 */
ApiV2OrdersStickersPost200Response.prototype['data'] = undefined;
...
export default ApiV2OrdersStickersPost200Response;
