...
/**
 * The ContentV1BarcodesPostRequest model module.
 * @module model/ContentV1BarcodesPostRequest
 * @version 1.6
 */
class ContentV1BarcodesPostRequest {
    /**
     * Constructs a new <code>ContentV1BarcodesPostRequest</code>.
     * @alias module:model/ContentV1BarcodesPostRequest
     */
    constructor() { 
        
        ContentV1BarcodesPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1BarcodesPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1BarcodesPostRequest} obj Optional instance to populate.
     * @return {module:model/ContentV1BarcodesPostRequest} The populated <code>ContentV1BarcodesPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1BarcodesPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1BarcodesPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1BarcodesPostRequest</code>.
     */
 ...
 * @member {Number} count
 */
ContentV1BarcodesPostRequest.prototype['count'] = undefined;
...
export default ContentV1BarcodesPostRequest;
