...
/**
 * The ApiV2StocksDeleteRequestInner1 model module.
 * @module model/ApiV2StocksDeleteRequestInner1
 * @version 1.6
 */
class ApiV2StocksDeleteRequestInner1 {
    /**
     * Constructs a new <code>ApiV2StocksDeleteRequestInner1</code>.
     * @alias module:model/ApiV2StocksDeleteRequestInner1
     */
    constructor() { 
        
        ApiV2StocksDeleteRequestInner1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2StocksDeleteRequestInner1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2StocksDeleteRequestInner1} obj Optional instance to populate.
     * @return {module:model/ApiV2StocksDeleteRequestInner1} The populated <code>ApiV2StocksDeleteRequestInner1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2StocksDeleteRequestInner1();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2StocksDeleteRequestInner1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2StocksDeleteRequestInner1</code>.
     */
 ...
 */
ApiV2StocksDeleteRequestInner1.prototype['barcode'] = undefined;

/**
 * ID склада.
 * @member {Number} warehouseId
 */
ApiV2StocksDeleteRequestInner1.prototype['warehouseId'] = undefined;
...
export default ApiV2StocksDeleteRequestInner1;
