...
import ApiV2StocksDelete200Response2DataInner from './ApiV2StocksDelete200Response2DataInner';

/**
 * The ApiV2StocksDelete200Response2 model module.
 * @module model/ApiV2StocksDelete200Response2
 * @version 1.6
 */
class ApiV2StocksDelete200Response2 {
    /**
     * Constructs a new <code>ApiV2StocksDelete200Response2</code>.
     * @alias module:model/ApiV2StocksDelete200Response2
     */
    constructor() { 
        
        ApiV2StocksDelete200Response2.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2StocksDelete200Response2</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2StocksDelete200Response2} obj Optional instance to populate.
     * @return {module:model/ApiV2StocksDelete200Response2} The populated <code>ApiV2StocksDelete200Response2</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2StocksDelete200Response2();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiClient.convertToType(data['data'], [ApiV2StocksDelete200Response2DataInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2StocksDelete200Response2</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2StocksDelete200Response2</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
            ...
            for (const item of data['data']) {
                ApiV2StocksDelete200Response2DataInner.validateJsonObject(item);
            };
        }
 ...
 */
ApiV2StocksDelete200Response2.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
ApiV2StocksDelete200Response2.prototype['errorText'] = undefined;

/**
 * Дополнительные ошибки.
 * @member {Object} additionalErrors
 */
ApiV2StocksDelete200Response2.prototype['additionalErrors'] = undefined;

/**
 * @member {Array.<module:model/ApiV2StocksDelete200Response2DataInner>} data
 */
ApiV2StocksDelete200Response2.prototype['data'] = undefined;
...
export default ApiV2StocksDelete200Response2;
