...
import ContentV1CardsUploadAddPostRequestCardsInnerSizesInner from './ContentV1CardsUploadAddPostRequestCardsInnerSizesInner';

/**
 * The ContentV1CardsUploadAddPostRequestCardsInner model module.
 * @module model/ContentV1CardsUploadAddPostRequestCardsInner
 * @version 1.6
 */
class ContentV1CardsUploadAddPostRequestCardsInner {
    /**
     * Constructs a new <code>ContentV1CardsUploadAddPostRequestCardsInner</code>.
     * @alias module:model/ContentV1CardsUploadAddPostRequestCardsInner
     */
    constructor() { 
        
        ContentV1CardsUploadAddPostRequestCardsInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsUploadAddPostRequestCardsInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsUploadAddPostRequestCardsInner} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsUploadAddPostRequestCardsInner} The populated <code>ContentV1CardsUploadAddPostRequestCardsInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsUploadAddPostRequestCardsInner();
            ...
            if (data.hasOwnProperty('sizes')) {
                obj['sizes'] = ApiClient.convertToType(data['sizes'], [ContentV1CardsUploadAddPostRequestCardsInnerSizesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsUploadAddPostRequestCardsInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsUploadAddPostRequestCardsInner</code>.
     */
    static validateJSON(data) {
        ...
        if (data['sizes']) { // data not null
            ...
            for (const item of data['sizes']) {
                ContentV1CardsUploadAddPostRequestCardsInnerSizesInner.validateJsonObject(item);
            };
        }
 ...
 */
ContentV1CardsUploadAddPostRequestCardsInner.prototype['vendorCode'] = undefined;

/**
 * Массив характеристик, индивидуальный для каждой категории
 * @member {Array.<Object>} characteristics
 */
ContentV1CardsUploadAddPostRequestCardsInner.prototype['characteristics'] = undefined;

/**
 * @member {Array.<module:model/ContentV1CardsUploadAddPostRequestCardsInnerSizesInner>} sizes
 */
ContentV1CardsUploadAddPostRequestCardsInner.prototype['sizes'] = undefined;
...
export default ContentV1CardsUploadAddPostRequestCardsInner;
