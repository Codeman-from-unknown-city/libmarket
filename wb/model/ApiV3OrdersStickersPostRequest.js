...
/**
 * The ApiV3OrdersStickersPostRequest model module.
 * @module model/ApiV3OrdersStickersPostRequest
 * @version 1.6
 */
class ApiV3OrdersStickersPostRequest {
    /**
     * Constructs a new <code>ApiV3OrdersStickersPostRequest</code>.
     * @alias module:model/ApiV3OrdersStickersPostRequest
     */
    constructor() { 
        
        ApiV3OrdersStickersPostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3OrdersStickersPostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3OrdersStickersPostRequest} obj Optional instance to populate.
     * @return {module:model/ApiV3OrdersStickersPostRequest} The populated <code>ApiV3OrdersStickersPostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3OrdersStickersPostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3OrdersStickersPostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3OrdersStickersPostRequest</code>.
     */
 ...
 */
ApiV3OrdersStickersPostRequest.prototype['orders'] = undefined;
...
export default ApiV3OrdersStickersPostRequest;
