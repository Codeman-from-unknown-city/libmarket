...
/**
 * The ContentV1DirectoryConsistsGet200ResponseDataInner model module.
 * @module model/ContentV1DirectoryConsistsGet200ResponseDataInner
 * @version 1.6
 */
class ContentV1DirectoryConsistsGet200ResponseDataInner {
    /**
     * Constructs a new <code>ContentV1DirectoryConsistsGet200ResponseDataInner</code>.
     * @alias module:model/ContentV1DirectoryConsistsGet200ResponseDataInner
     */
    constructor() { 
        
        ContentV1DirectoryConsistsGet200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1DirectoryConsistsGet200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1DirectoryConsistsGet200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ContentV1DirectoryConsistsGet200ResponseDataInner} The populated <code>ContentV1DirectoryConsistsGet200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1DirectoryConsistsGet200ResponseDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1DirectoryConsistsGet200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1DirectoryConsistsGet200ResponseDataInner</code>.
     */
 ...
 * @member {Number} id
 */
ContentV1DirectoryConsistsGet200ResponseDataInner.prototype['id'] = undefined;

/**
 * Значение характеристики
 * @member {String} name
 */
ContentV1DirectoryConsistsGet200ResponseDataInner.prototype['name'] = undefined;
...
export default ContentV1DirectoryConsistsGet200ResponseDataInner;
