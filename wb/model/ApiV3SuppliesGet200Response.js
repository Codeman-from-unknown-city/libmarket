...
/**
 * The ApiV3SuppliesGet200Response model module.
 * @module model/ApiV3SuppliesGet200Response
 * @version 1.6
 */
class ApiV3SuppliesGet200Response {
    /**
     * Constructs a new <code>ApiV3SuppliesGet200Response</code>.
     * @alias module:model/ApiV3SuppliesGet200Response
     */
    constructor() { 
        
        ApiV3SuppliesGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3SuppliesGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3SuppliesGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV3SuppliesGet200Response} The populated <code>ApiV3SuppliesGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3SuppliesGet200Response();

            if (data.hasOwnProperty('next')) {
                obj['next'] = ApiClient.convertToType(data['next'], 'Number');
            }
            if (data.hasOwnProperty('supplies')) {
                obj['supplies'] = ApiClient.convertToType(data['supplies'], [Supply]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3SuppliesGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3SuppliesGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['supplies']) { // data not null
            ...
            for (const item of data['supplies']) {
                Supply.validateJsonObject(item);
            };
        }
 ...
 * @member {Number} next
 */
ApiV3SuppliesGet200Response.prototype['next'] = undefined;

/**
 * Список поставок
 * @member {Array.<module:model/Supply>} supplies
 */
ApiV3SuppliesGet200Response.prototype['supplies'] = undefined;
...
export default ApiV3SuppliesGet200Response;
