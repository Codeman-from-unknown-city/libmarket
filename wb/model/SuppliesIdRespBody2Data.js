...
/**
 * The SuppliesIdRespBody2Data model module.
 * @module model/SuppliesIdRespBody2Data
 * @version 1.6
 */
class SuppliesIdRespBody2Data {
    /**
     * Constructs a new <code>SuppliesIdRespBody2Data</code>.
     * @alias module:model/SuppliesIdRespBody2Data
     */
    constructor() { 
        
        SuppliesIdRespBody2Data.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SuppliesIdRespBody2Data</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuppliesIdRespBody2Data} obj Optional instance to populate.
     * @return {module:model/SuppliesIdRespBody2Data} The populated <code>SuppliesIdRespBody2Data</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuppliesIdRespBody2Data();

            if (data.hasOwnProperty('failedOrders')) {
                obj['failedOrders'] = ApiClient.convertToType(data['failedOrders'], ['String']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>SuppliesIdRespBody2Data</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuppliesIdRespBody2Data</code>.
     */
    static validateJSON(data) {
        // ensure the json data is an array
        if (!Array.isArray(data['failedOrders'])) {
            throw new Error("Expected the field `failedOrders` to be an array in the JSON data but got " + data['failedOrders']);
        }
 ...
 * @member {Array.<String>} failedOrders
 */
SuppliesIdRespBody2Data.prototype['failedOrders'] = undefined;
...
export default SuppliesIdRespBody2Data;
