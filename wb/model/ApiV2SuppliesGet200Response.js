...
import ApiV2SuppliesGet200ResponseSuppliesInner from './ApiV2SuppliesGet200ResponseSuppliesInner';

/**
 * The ApiV2SuppliesGet200Response model module.
 * @module model/ApiV2SuppliesGet200Response
 * @version 1.6
 */
class ApiV2SuppliesGet200Response {
    /**
     * Constructs a new <code>ApiV2SuppliesGet200Response</code>.
     * @alias module:model/ApiV2SuppliesGet200Response
     */
    constructor() { 
        
        ApiV2SuppliesGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2SuppliesGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2SuppliesGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV2SuppliesGet200Response} The populated <code>ApiV2SuppliesGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2SuppliesGet200Response();

            if (data.hasOwnProperty('supplies')) {
                obj['supplies'] = ApiClient.convertToType(data['supplies'], [ApiV2SuppliesGet200ResponseSuppliesInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2SuppliesGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2SuppliesGet200Response</code>.
     */
    static validateJSON(data) {
        if (data['supplies']) { // data not null
            // ensure the json data is an array
            if (!Array.isArray(data['supplies'])) {
                throw new Error("Expected the field `supplies` to be an array in the JSON data but got " + data['supplies']);
            }
            // validate the optional field `supplies` (array)
            for (const item of data['supplies']) {
                ApiV2SuppliesGet200ResponseSuppliesInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV2SuppliesGet200ResponseSuppliesInner>} supplies
 */
ApiV2SuppliesGet200Response.prototype['supplies'] = undefined;
...
export default ApiV2SuppliesGet200Response;
