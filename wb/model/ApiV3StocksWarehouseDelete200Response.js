...
import ApiV3StocksWarehouseDelete200ResponseStocksInner from './ApiV3StocksWarehouseDelete200ResponseStocksInner';

/**
 * The ApiV3StocksWarehouseDelete200Response model module.
 * @module model/ApiV3StocksWarehouseDelete200Response
 * @version 1.6
 */
class ApiV3StocksWarehouseDelete200Response {
    /**
     * Constructs a new <code>ApiV3StocksWarehouseDelete200Response</code>.
     * @alias module:model/ApiV3StocksWarehouseDelete200Response
     */
    constructor() { 
        
        ApiV3StocksWarehouseDelete200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3StocksWarehouseDelete200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3StocksWarehouseDelete200Response} obj Optional instance to populate.
     * @return {module:model/ApiV3StocksWarehouseDelete200Response} The populated <code>ApiV3StocksWarehouseDelete200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3StocksWarehouseDelete200Response();

            if (data.hasOwnProperty('stocks')) {
                obj['stocks'] = ApiClient.convertToType(data['stocks'], [ApiV3StocksWarehouseDelete200ResponseStocksInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3StocksWarehouseDelete200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3StocksWarehouseDelete200Response</code>.
     */
    static validateJSON(data) {
        if (data['stocks']) { // data not null
            ...
            for (const item of data['stocks']) {
                ApiV3StocksWarehouseDelete200ResponseStocksInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV3StocksWarehouseDelete200ResponseStocksInner>} stocks
 */
ApiV3StocksWarehouseDelete200Response.prototype['stocks'] = undefined;
...
export default ApiV3StocksWarehouseDelete200Response;
