...
/**
 * The ContentV1CardsCursorListPostRequestSortSort model module.
 * @module model/ContentV1CardsCursorListPostRequestSortSort
 * @version 1.6
 */
class ContentV1CardsCursorListPostRequestSortSort {
    /**
     * Constructs a new <code>ContentV1CardsCursorListPostRequestSortSort</code>.
     * @alias module:model/ContentV1CardsCursorListPostRequestSortSort
     */
    constructor() { 
        
        ContentV1CardsCursorListPostRequestSortSort.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1CardsCursorListPostRequestSortSort</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1CardsCursorListPostRequestSortSort} obj Optional instance to populate.
     * @return {module:model/ContentV1CardsCursorListPostRequestSortSort} The populated <code>ContentV1CardsCursorListPostRequestSortSort</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1CardsCursorListPostRequestSortSort();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1CardsCursorListPostRequestSortSort</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1CardsCursorListPostRequestSortSort</code>.
     */
 ...
 */
ContentV1CardsCursorListPostRequestSortSort.prototype['sortColumn'] = undefined;

/**
 * Тип сортировки.
 * @member {Boolean} ascending
 */
ContentV1CardsCursorListPostRequestSortSort.prototype['ascending'] = undefined;
...
export default ContentV1CardsCursorListPostRequestSortSort;
