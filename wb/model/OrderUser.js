...
/**
 * The OrderUser model module.
 * @module model/OrderUser
 * @version 1.6
 */
class OrderUser {
    /**
     * Constructs a new <code>OrderUser</code>.
     * Информация о клиенте (только для доставки силами продавца)
     * @alias module:model/OrderUser
     */
    constructor() { 
        
        OrderUser.initialize(this);
    }
    ...
    /**
     * Constructs a <code>OrderUser</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/OrderUser} obj Optional instance to populate.
     * @return {module:model/OrderUser} The populated <code>OrderUser</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new OrderUser();

            if (data.hasOwnProperty('fio')) {
                obj['fio'] = ApiClient.convertToType(data['fio'], 'String');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>OrderUser</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>OrderUser</code>.
     */
    static validateJSON(data) {
        // ensure the json data is a string
        if (data['fio'] && !(typeof data['fio'] === 'string' || data['fio'] instanceof String)) {
            throw new Error("Expected the field `fio` to be a primitive type in the JSON string but got " + data['fio']);
        }
        // ensure the json data is a string
 ...
 * @member {String} fio
 */
OrderUser.prototype['fio'] = undefined;

/**
 * Номер телефона
 * @member {String} phone
 */
OrderUser.prototype['phone'] = undefined;
