...
import ApiV3OrdersStatusPost200ResponseOrdersInner from './ApiV3OrdersStatusPost200ResponseOrdersInner';

/**
 * The ApiV3OrdersStatusPost200Response model module.
 * @module model/ApiV3OrdersStatusPost200Response
 * @version 1.6
 */
class ApiV3OrdersStatusPost200Response {
    /**
     * Constructs a new <code>ApiV3OrdersStatusPost200Response</code>.
     * @alias module:model/ApiV3OrdersStatusPost200Response
     */
    constructor() { 
        
        ApiV3OrdersStatusPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3OrdersStatusPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3OrdersStatusPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV3OrdersStatusPost200Response} The populated <code>ApiV3OrdersStatusPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3OrdersStatusPost200Response();

            if (data.hasOwnProperty('orders')) {
                obj['orders'] = ApiClient.convertToType(data['orders'], [ApiV3OrdersStatusPost200ResponseOrdersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3OrdersStatusPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3OrdersStatusPost200Response</code>.
     */
    static validateJSON(data) {
        if (data['orders']) { // data not null
            ...
            for (const item of data['orders']) {
                ApiV3OrdersStatusPost200ResponseOrdersInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV3OrdersStatusPost200ResponseOrdersInner>} orders
 */
ApiV3OrdersStatusPost200Response.prototype['orders'] = undefined;
...
export default ApiV3OrdersStatusPost200Response;
