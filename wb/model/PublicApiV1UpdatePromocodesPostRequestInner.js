...
/**
 * The PublicApiV1UpdatePromocodesPostRequestInner model module.
 * @module model/PublicApiV1UpdatePromocodesPostRequestInner
 * @version 1.6
 */
class PublicApiV1UpdatePromocodesPostRequestInner {
    /**
     * Constructs a new <code>PublicApiV1UpdatePromocodesPostRequestInner</code>.
     * @alias module:model/PublicApiV1UpdatePromocodesPostRequestInner
     */
    constructor() { 
        
        PublicApiV1UpdatePromocodesPostRequestInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PublicApiV1UpdatePromocodesPostRequestInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublicApiV1UpdatePromocodesPostRequestInner} obj Optional instance to populate.
     * @return {module:model/PublicApiV1UpdatePromocodesPostRequestInner} The populated <code>PublicApiV1UpdatePromocodesPostRequestInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicApiV1UpdatePromocodesPostRequestInner();

            if (data.hasOwnProperty('promoCode')) {
                obj['promoCode'] = ApiClient.convertToType(data['promoCode'], 'Number');
            }
    ...
    /**
     * Validates the JSON data with respect to <code>PublicApiV1UpdatePromocodesPostRequestInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicApiV1UpdatePromocodesPostRequestInner</code>.
     */
...
/**
 * Промокод
 * @member {Number} promoCode
 */
PublicApiV1UpdatePromocodesPostRequestInner.prototype['promoCode'] = undefined;

/**
 * Номенклатура
 * @member {Number} nm
 */
PublicApiV1UpdatePromocodesPostRequestInner.prototype['nm'] = undefined;
...
export default PublicApiV1UpdatePromocodesPostRequestInner;
