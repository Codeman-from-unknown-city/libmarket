...
import ApiV2StocksDelete200Response1DataErrorInner from './ApiV2StocksDelete200Response1DataErrorInner';

/**
 * The ApiV2StocksDelete200Response1Data model module.
 * @module model/ApiV2StocksDelete200Response1Data
 * @version 1.6
 */
class ApiV2StocksDelete200Response1Data {
    /**
     * Constructs a new <code>ApiV2StocksDelete200Response1Data</code>.
     * @alias module:model/ApiV2StocksDelete200Response1Data
     */
    constructor() { 
        
        ApiV2StocksDelete200Response1Data.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2StocksDelete200Response1Data</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2StocksDelete200Response1Data} obj Optional instance to populate.
     * @return {module:model/ApiV2StocksDelete200Response1Data} The populated <code>ApiV2StocksDelete200Response1Data</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2StocksDelete200Response1Data();

            if (data.hasOwnProperty('error')) {
                obj['error'] = ApiClient.convertToType(data['error'], [ApiV2StocksDelete200Response1DataErrorInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2StocksDelete200Response1Data</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2StocksDelete200Response1Data</code>.
     */
    static validateJSON(data) {
        if (data['error']) { // data not null
            ...
            for (const item of data['error']) {
                ApiV2StocksDelete200Response1DataErrorInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV2StocksDelete200Response1DataErrorInner>} error
 */
ApiV2StocksDelete200Response1Data.prototype['error'] = undefined;
...
export default ApiV2StocksDelete200Response1Data;
