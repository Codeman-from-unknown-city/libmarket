...
import ApiV3OrdersStickersPost200ResponseStickersInner from './ApiV3OrdersStickersPost200ResponseStickersInner';

/**
 * The ApiV3OrdersStickersPost200Response model module.
 * @module model/ApiV3OrdersStickersPost200Response
 * @version 1.6
 */
class ApiV3OrdersStickersPost200Response {
    /**
     * Constructs a new <code>ApiV3OrdersStickersPost200Response</code>.
     * @alias module:model/ApiV3OrdersStickersPost200Response
     */
    constructor() { 
        
        ApiV3OrdersStickersPost200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3OrdersStickersPost200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3OrdersStickersPost200Response} obj Optional instance to populate.
     * @return {module:model/ApiV3OrdersStickersPost200Response} The populated <code>ApiV3OrdersStickersPost200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3OrdersStickersPost200Response();

            if (data.hasOwnProperty('stickers')) {
                obj['stickers'] = ApiClient.convertToType(data['stickers'], [ApiV3OrdersStickersPost200ResponseStickersInner]);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3OrdersStickersPost200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3OrdersStickersPost200Response</code>.
     */
    static validateJSON(data) {
        if (data['stickers']) { // data not null
            ...
            for (const item of data['stickers']) {
                ApiV3OrdersStickersPost200ResponseStickersInner.validateJsonObject(item);
            };
        }
...
/**
 * @member {Array.<module:model/ApiV3OrdersStickersPost200ResponseStickersInner>} stickers
 */
ApiV3OrdersStickersPost200Response.prototype['stickers'] = undefined;
...
export default ApiV3OrdersStickersPost200Response;
