...
/**
 * The ApiV3OrdersGet200Response model module.
 * @module model/ApiV3OrdersGet200Response
 * @version 1.6
 */
class ApiV3OrdersGet200Response {
    /**
     * Constructs a new <code>ApiV3OrdersGet200Response</code>.
     * @alias module:model/ApiV3OrdersGet200Response
     */
    constructor() { 
        
        ApiV3OrdersGet200Response.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3OrdersGet200Response</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3OrdersGet200Response} obj Optional instance to populate.
     * @return {module:model/ApiV3OrdersGet200Response} The populated <code>ApiV3OrdersGet200Response</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3OrdersGet200Response();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3OrdersGet200Response</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3OrdersGet200Response</code>.
     */
 ...
 * @member {Number} next
 */
ApiV3OrdersGet200Response.prototype['next'] = undefined;

/**
 * @member {Array.<module:model/Order>} orders
 */
ApiV3OrdersGet200Response.prototype['orders'] = undefined;
...
export default ApiV3OrdersGet200Response;
