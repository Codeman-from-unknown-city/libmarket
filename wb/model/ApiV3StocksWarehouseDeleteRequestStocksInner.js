...
/**
 * The ApiV3StocksWarehouseDeleteRequestStocksInner model module.
 * @module model/ApiV3StocksWarehouseDeleteRequestStocksInner
 * @version 1.6
 */
class ApiV3StocksWarehouseDeleteRequestStocksInner {
    /**
     * Constructs a new <code>ApiV3StocksWarehouseDeleteRequestStocksInner</code>.
     * @alias module:model/ApiV3StocksWarehouseDeleteRequestStocksInner
     */
    constructor() { 
        
        ApiV3StocksWarehouseDeleteRequestStocksInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV3StocksWarehouseDeleteRequestStocksInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV3StocksWarehouseDeleteRequestStocksInner} obj Optional instance to populate.
     * @return {module:model/ApiV3StocksWarehouseDeleteRequestStocksInner} The populated <code>ApiV3StocksWarehouseDeleteRequestStocksInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV3StocksWarehouseDeleteRequestStocksInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV3StocksWarehouseDeleteRequestStocksInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV3StocksWarehouseDeleteRequestStocksInner</code>.
     */
 ...
 * @member {String} sku
 */
ApiV3StocksWarehouseDeleteRequestStocksInner.prototype['sku'] = undefined;

/**
 * Остаток
 * @member {Number} amount
 */
ApiV3StocksWarehouseDeleteRequestStocksInner.prototype['amount'] = undefined;
...
export default ApiV3StocksWarehouseDeleteRequestStocksInner;
