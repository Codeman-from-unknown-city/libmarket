...
/**
 * The SuppliesIdRespBody model module.
 * @module model/SuppliesIdRespBody
 * @version 1.6
 */
class SuppliesIdRespBody {
    /**
     * Constructs a new <code>SuppliesIdRespBody</code>.
     * @alias module:model/SuppliesIdRespBody
     */
    constructor() { 
        
        SuppliesIdRespBody.initialize(this);
    }
    ...
    /**
     * Constructs a <code>SuppliesIdRespBody</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/SuppliesIdRespBody} obj Optional instance to populate.
     * @return {module:model/SuppliesIdRespBody} The populated <code>SuppliesIdRespBody</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new SuppliesIdRespBody();
    ...
    /**
     * Validates the JSON data with respect to <code>SuppliesIdRespBody</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>SuppliesIdRespBody</code>.
     */
 ...
 */
SuppliesIdRespBody.prototype['additionalErrors'] = undefined;

/**
 * @member {Object} data
 */
SuppliesIdRespBody.prototype['data'] = undefined;

/**
 * Флаг ошибки.
 * @member {Boolean} error
 */
SuppliesIdRespBody.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
SuppliesIdRespBody.prototype['errorText'] = undefined;
...
export default SuppliesIdRespBody;
