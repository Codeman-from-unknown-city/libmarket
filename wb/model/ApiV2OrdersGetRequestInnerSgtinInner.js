...
/**
 * The ApiV2OrdersGetRequestInnerSgtinInner model module.
 * @module model/ApiV2OrdersGetRequestInnerSgtinInner
 * @version 1.6
 */
class ApiV2OrdersGetRequestInnerSgtinInner {
    /**
     * Constructs a new <code>ApiV2OrdersGetRequestInnerSgtinInner</code>.
     * @alias module:model/ApiV2OrdersGetRequestInnerSgtinInner
     */
    constructor() { 
        
        ApiV2OrdersGetRequestInnerSgtinInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2OrdersGetRequestInnerSgtinInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2OrdersGetRequestInnerSgtinInner} obj Optional instance to populate.
     * @return {module:model/ApiV2OrdersGetRequestInnerSgtinInner} The populated <code>ApiV2OrdersGetRequestInnerSgtinInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2OrdersGetRequestInnerSgtinInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2OrdersGetRequestInnerSgtinInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2OrdersGetRequestInnerSgtinInner</code>.
     */
 ...
 * @member {String} code
 */
ApiV2OrdersGetRequestInnerSgtinInner.prototype['code'] = undefined;

/**
 * Числитель, количество единиц товара из упаковки (1, если продается целая упаковка). 
 * @member {Number} numerator
 */
ApiV2OrdersGetRequestInnerSgtinInner.prototype['numerator'] = undefined;
 ...
 */
ApiV2OrdersGetRequestInnerSgtinInner.prototype['denominator'] = undefined;

/**
 * Идентификатор места деятельности субъекта обращения в ИС МДЛП. 
 * @member {Number} sid
 */
ApiV2OrdersGetRequestInnerSgtinInner.prototype['sid'] = undefined;
...
export default ApiV2OrdersGetRequestInnerSgtinInner;
