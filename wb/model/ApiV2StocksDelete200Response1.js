...
import ApiV2StocksDelete200Response1Data from './ApiV2StocksDelete200Response1Data';

/**
 * The ApiV2StocksDelete200Response1 model module.
 * @module model/ApiV2StocksDelete200Response1
 * @version 1.6
 */
class ApiV2StocksDelete200Response1 {
    /**
     * Constructs a new <code>ApiV2StocksDelete200Response1</code>.
     * @alias module:model/ApiV2StocksDelete200Response1
     */
    constructor() { 
        
        ApiV2StocksDelete200Response1.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ApiV2StocksDelete200Response1</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ApiV2StocksDelete200Response1} obj Optional instance to populate.
     * @return {module:model/ApiV2StocksDelete200Response1} The populated <code>ApiV2StocksDelete200Response1</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ApiV2StocksDelete200Response1();
            ...
            if (data.hasOwnProperty('data')) {
                obj['data'] = ApiV2StocksDelete200Response1Data.constructFromObject(data['data']);
            }
        }
        return obj;
    }
    ...
    /**
     * Validates the JSON data with respect to <code>ApiV2StocksDelete200Response1</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ApiV2StocksDelete200Response1</code>.
     */
    static validateJSON(data) {
        ...
        if (data['data']) { // data not null
          ApiV2StocksDelete200Response1Data.validateJSON(data['data']);
        }
 ...
 */
ApiV2StocksDelete200Response1.prototype['error'] = undefined;

/**
 * @member {String} errorText
 */
ApiV2StocksDelete200Response1.prototype['errorText'] = undefined;

/**
 * @member {Array.<Object>} additionalErrors
 */
ApiV2StocksDelete200Response1.prototype['additionalErrors'] = undefined;

/**
 * @member {module:model/ApiV2StocksDelete200Response1Data} data
 */
ApiV2StocksDelete200Response1.prototype['data'] = undefined;
...
export default ApiV2StocksDelete200Response1;
