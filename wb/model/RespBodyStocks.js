...
/**
 * The RespBodyStocks model module.
 * @module model/RespBodyStocks
 * @version 1.6
 */
class RespBodyStocks {
    /**
     * Constructs a new <code>RespBodyStocks</code>.
     * @alias module:model/RespBodyStocks
     */
    constructor() { 
        
        RespBodyStocks.initialize(this);
    }
    ...
    /**
     * Constructs a <code>RespBodyStocks</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/RespBodyStocks} obj Optional instance to populate.
     * @return {module:model/RespBodyStocks} The populated <code>RespBodyStocks</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RespBodyStocks();
    ...
    /**
     * Validates the JSON data with respect to <code>RespBodyStocks</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>RespBodyStocks</code>.
     */
 ...
 */
RespBodyStocks.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
RespBodyStocks.prototype['errorText'] = undefined;

/**
 * Дополнительные ошибки.
 * @member {Object} additionalErrors
 */
RespBodyStocks.prototype['additionalErrors'] = undefined;

/**
 * @member {Object} data
 */
RespBodyStocks.prototype['data'] = undefined;
