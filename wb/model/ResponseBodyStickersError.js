...
/**
 * The ResponseBodyStickersError model module.
 * @module model/ResponseBodyStickersError
 * @version 1.6
 */
class ResponseBodyStickersError {
    /**
     * Constructs a new <code>ResponseBodyStickersError</code>.
     * @alias module:model/ResponseBodyStickersError
     */
    constructor() { 
        
        ResponseBodyStickersError.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ResponseBodyStickersError</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ResponseBodyStickersError} obj Optional instance to populate.
     * @return {module:model/ResponseBodyStickersError} The populated <code>ResponseBodyStickersError</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ResponseBodyStickersError();
    ...
    /**
     * Validates the JSON data with respect to <code>ResponseBodyStickersError</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ResponseBodyStickersError</code>.
     */
 ...
 * @member {Object} data
 */
ResponseBodyStickersError.prototype['data'] = undefined;

/**
 * Флаг ошибки.
 * @member {Boolean} error
 */
ResponseBodyStickersError.prototype['error'] = undefined;

/**
 * Описание ошибки.
 * @member {String} errorText
 */
ResponseBodyStickersError.prototype['errorText'] = undefined;

/**
 * Дополнительные ошибки.
 * @member {String} additionalErrors
 */
ResponseBodyStickersError.prototype['additionalErrors'] = undefined;
...
export default ResponseBodyStickersError;
