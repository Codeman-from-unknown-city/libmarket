...
/**
 * The PublicApiV1UpdateDiscountsPostRequestInner model module.
 * @module model/PublicApiV1UpdateDiscountsPostRequestInner
 * @version 1.6
 */
class PublicApiV1UpdateDiscountsPostRequestInner {
    /**
     * Constructs a new <code>PublicApiV1UpdateDiscountsPostRequestInner</code>.
     * @alias module:model/PublicApiV1UpdateDiscountsPostRequestInner
     */
    constructor() { 
        
        PublicApiV1UpdateDiscountsPostRequestInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PublicApiV1UpdateDiscountsPostRequestInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PublicApiV1UpdateDiscountsPostRequestInner} obj Optional instance to populate.
     * @return {module:model/PublicApiV1UpdateDiscountsPostRequestInner} The populated <code>PublicApiV1UpdateDiscountsPostRequestInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PublicApiV1UpdateDiscountsPostRequestInner();
    ...
    /**
     * Validates the JSON data with respect to <code>PublicApiV1UpdateDiscountsPostRequestInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>PublicApiV1UpdateDiscountsPostRequestInner</code>.
     */
 ...
 */
PublicApiV1UpdateDiscountsPostRequestInner.prototype['discount'] = undefined;

/**
 * Номенклатура
 * @member {Number} nm
 */
PublicApiV1UpdateDiscountsPostRequestInner.prototype['nm'] = undefined;
...
export default PublicApiV1UpdateDiscountsPostRequestInner;
