...
/**
 * The ContentV1MediaSavePostRequest model module.
 * @module model/ContentV1MediaSavePostRequest
 * @version 1.6
 */
class ContentV1MediaSavePostRequest {
    /**
     * Constructs a new <code>ContentV1MediaSavePostRequest</code>.
     * @alias module:model/ContentV1MediaSavePostRequest
     */
    constructor() { 
        
        ContentV1MediaSavePostRequest.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1MediaSavePostRequest</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1MediaSavePostRequest} obj Optional instance to populate.
     * @return {module:model/ContentV1MediaSavePostRequest} The populated <code>ContentV1MediaSavePostRequest</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1MediaSavePostRequest();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1MediaSavePostRequest</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1MediaSavePostRequest</code>.
     */
 ...
 */
ContentV1MediaSavePostRequest.prototype['vendorCode'] = undefined;

/**
 * Ссылки на изображения в том порядке, в котором мы хотим их увидеть в карточке товара.
 * @member {Array.<String>} data
 */
ContentV1MediaSavePostRequest.prototype['data'] = undefined;
...
export default ContentV1MediaSavePostRequest;
