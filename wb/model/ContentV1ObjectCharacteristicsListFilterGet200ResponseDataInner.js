...
/**
 * The ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner model module.
 * @module model/ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner
 * @version 1.6
 */
class ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner {
    /**
     * Constructs a new <code>ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner</code>.
     * @alias module:model/ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner
     */
    constructor() { 
        
        ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner.initialize(this);
    }
    ...
    /**
     * Constructs a <code>ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner} obj Optional instance to populate.
     * @return {module:model/ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner} The populated <code>ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner();
    ...
    /**
     * Validates the JSON data with respect to <code>ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner</code>.
     */
 ...
 */
ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner.prototype['objectName'] = undefined;

/**
 * Наименование характеристики
 * @member {String} name
 */
ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner.prototype['name'] = undefined;

/**
 * Характеристика обязательна к заполенению
 * @member {Boolean} required
 */
ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner.prototype['required'] = undefined;

/**
 * Единица имерения (см, гр и т.д.)
 * @member {String} unitName
 */
ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner.prototype['unitName'] = undefined;

/**
 * Максимальное кол-во значений которое можно присвоить данной характеристике
 * @member {Number} maxCount
 */
ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner.prototype['maxCount'] = undefined;

/**
 * Характеристика популярна у пользователей
 * @member {Boolean} popular
 */
ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner.prototype['popular'] = undefined;

/**
 * Тип характеристики (1 и 0 - строка или массив строк; 4 - число или массив чисел)
 * @member {Number} charcType
 */
ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner.prototype['charcType'] = undefined;
...
export default ContentV1ObjectCharacteristicsListFilterGet200ResponseDataInner;
