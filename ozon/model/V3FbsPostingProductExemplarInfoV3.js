...
/**
 * The V3FbsPostingProductExemplarInfoV3 model module.
 * @module model/V3FbsPostingProductExemplarInfoV3
 * @version 2.1
 */
class V3FbsPostingProductExemplarInfoV3 {
    /**
     * Constructs a new <code>V3FbsPostingProductExemplarInfoV3</code>.
     * @alias module:model/V3FbsPostingProductExemplarInfoV3
     */
    constructor() { 
        
        V3FbsPostingProductExemplarInfoV3.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V3FbsPostingProductExemplarInfoV3</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V3FbsPostingProductExemplarInfoV3} obj Optional instance to populate.
     * @return {module:model/V3FbsPostingProductExemplarInfoV3} The populated <code>V3FbsPostingProductExemplarInfoV3</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V3FbsPostingProductExemplarInfoV3();
    ...
    /**
     * Validates the JSON data with respect to <code>V3FbsPostingProductExemplarInfoV3</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V3FbsPostingProductExemplarInfoV3</code>.
     */
 ...
 */
V3FbsPostingProductExemplarInfoV3.prototype['mandatory_mark'] = undefined;

/**
 * Номер грузовой таможенной декларации (ГТД).
 * @member {String} gtd
 */
V3FbsPostingProductExemplarInfoV3.prototype['gtd'] = undefined;

/**
 * Признак того, что не указан номер таможенной декларации.
 * @member {Boolean} is_gtd_absent
 */
V3FbsPostingProductExemplarInfoV3.prototype['is_gtd_absent'] = undefined;

/**
 * Регистрационный номер партии товара (РНПТ).
 * @member {String} rnpt
 */
V3FbsPostingProductExemplarInfoV3.prototype['rnpt'] = undefined;

/**
 * Признак того, что не указан регистрационный номер партии товара (РНПТ).
 * @member {Boolean} is_rnpt_absent
 */
V3FbsPostingProductExemplarInfoV3.prototype['is_rnpt_absent'] = undefined;
...
export default V3FbsPostingProductExemplarInfoV3;
