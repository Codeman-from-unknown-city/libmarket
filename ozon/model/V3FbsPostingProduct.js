...
/**
 * The V3FbsPostingProduct model module.
 * @module model/V3FbsPostingProduct
 * @version 2.1
 */
class V3FbsPostingProduct {
    /**
     * Constructs a new <code>V3FbsPostingProduct</code>.
     * @alias module:model/V3FbsPostingProduct
     */
    constructor() { 
        
        V3FbsPostingProduct.initialize(this);
    }
    ...
    /**
     * Constructs a <code>V3FbsPostingProduct</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/V3FbsPostingProduct} obj Optional instance to populate.
     * @return {module:model/V3FbsPostingProduct} The populated <code>V3FbsPostingProduct</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new V3FbsPostingProduct();
    ...
    /**
     * Validates the JSON data with respect to <code>V3FbsPostingProduct</code>.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @return {boolean} to indicate whether the JSON data is valid with respect to <code>V3FbsPostingProduct</code>.
     */
 ...
 */
V3FbsPostingProduct.prototype['mandatory_mark'] = undefined;

/**
 * Название товара.
 * @member {String} name
 */
V3FbsPostingProduct.prototype['name'] = undefined;

/**
 * Идентификатор товара в системе продавца — артикул.
 * @member {String} offer_id
 */
V3FbsPostingProduct.prototype['offer_id'] = undefined;

/**
 * Цена товара.
 * @member {String} price
 */
V3FbsPostingProduct.prototype['price'] = undefined;

/**
 * Количество товара в отправлении.
 * @member {Number} quantity
 */
V3FbsPostingProduct.prototype['quantity'] = undefined;

/**
 * Идентификатор товара в системе Ozon — SKU.
 * @member {Number} sku
 */
V3FbsPostingProduct.prototype['sku'] = undefined;
 ...
 */
V3FbsPostingProduct.prototype['currency_code'] = undefined;
...
export default V3FbsPostingProduct;
